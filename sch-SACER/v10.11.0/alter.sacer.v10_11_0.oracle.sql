...
-- changeset root:1760715398880-302
...
-- changeset root:1760715398880-303
...
-- changeset root:1760715398880-304 splitStatements:true
...
-- changeset root:1760715398880-305
...
-- changeset root:1760715398880-306
...
-- changeset root:1760715398880-307
...
-- changeset root:1760715398880-308
...
-- changeset root:1760715398880-309
...
-- changeset root:1760715398880-310
...
-- changeset root:1760715398880-311 splitStatements:true
CREATE TABLE DM_UD_DEL_RICHIESTE (ID_UD_DEL_RICHIESTA NUMBER NOT NULL, ID_RICHIESTA NUMBER NOT NULL, CD_RICHIESTA VARCHAR2(4000 CHAR), TI_MOT_CANCELLAZIONE VARCHAR2(1 CHAR) NOT NULL, TI_STATO_RICHIESTA VARCHAR2(100 CHAR) NOT NULL, TI_MOD_DEL VARCHAR2(255 CHAR), DT_CREAZIONE date DEFAULT SYSDATE NOT NULL, DT_ULTIMO_AGGIORNAMENTO date, TI_STATO_INTERNO_RICH VARCHAR2(100 CHAR) DEFAULT 'INIZIALE' NOT NULL, DS_MESSAGGIO_ERRORE VARCHAR2(4000 CHAR), CONSTRAINT PK_UD_DEL_RICHIESTA PRIMARY KEY (ID_UD_DEL_RICHIESTA));
COMMENT ON TABLE DM_UD_DEL_RICHIESTE IS 'Tabella master per lo stato aggregato delle richieste di cancellazione.';

-- changeset root:1760715398880-312 splitStatements:true
CREATE TABLE DM_UD_DEL (ID_UNITA_DOC NUMBER NOT NULL, AA_KEY_UNITA_DOC NUMBER(4, 0) NOT NULL, CD_KEY_UNITA_DOC VARCHAR2(100 BYTE) NOT NULL, CD_REGISTRO_KEY_UNITA_DOC VARCHAR2(100 BYTE) NOT NULL, DT_VERSAMENTO date NOT NULL, ID_ENTE NUMBER NOT NULL, NM_ENTE VARCHAR2(4000 BYTE) NOT NULL, ID_STRUT NUMBER NOT NULL, NM_STRUT VARCHAR2(4000 BYTE) NOT NULL, ID_UD_DEL_RICHIESTA NUMBER NOT NULL, TI_STATO_UD_CANCELLATE VARCHAR2(100 BYTE) NOT NULL, DT_STATO_UD_CANCELLATE date NOT NULL, CONSTRAINT PK_DM_UD_DEL PRIMARY KEY (ID_UNITA_DOC));
COMMENT ON COLUMN DM_UD_DEL.DT_VERSAMENTO IS 'Data di creazione dell''ud';

-- changeset root:1760715398880-313
CREATE TABLE DM_UD_DEL_BATCH_JOBS (JOB_ID NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL, JOB_NAME VARCHAR2(100 CHAR) NOT NULL, ID_UD_DEL_RICHIESTA NUMBER NOT NULL, TI_STATO_JOB VARCHAR2(100 CHAR) NOT NULL, DT_CREAZIONE TIMESTAMP(6) DEFAULT SYSTIMESTAMP NOT NULL, DT_INIZIO_EXEC TIMESTAMP(6), DT_FINE_EXEC TIMESTAMP(6), DS_MESSAGGIO_ERRORE VARCHAR2(4000 CHAR), CONSTRAINT SYS_C0079128 PRIMARY KEY (JOB_ID));

-- changeset root:1760715398880-314
...
-- changeset root:1760715398880-315
...
-- changeset root:1760715398880-316
...
-- changeset root:1760715398880-317
...
-- changeset root:1760715398880-318
...
-- changeset root:1760715398880-323
...
-- changeset root:1760715398880-324
...
-- changeset root:1760715398880-325
...
-- changeset root:1760715398880-326
...
-- changeset root:1760715398880-327
...
-- changeset root:1760715398880-328
...
-- changeset root:1760715398880-329
CREATE OR REPLACE FORCE VIEW MON_V_CNT_UD_UPD_KO_STRUT (ID_STRUT, ID_USER_IAM, TI_STATO_SES_UPD_KO, NI_UPD_UD_KO) AS with tmp_abil_key_ud_ko as (
    select 
        id_key_total_ud_ko, 
        id_strut, 
        id_user_iam_cor as id_user_iam,
        aa_key_unita_doc,
        id_tipo_unita_doc,
        id_registro_unita_doc,
        id_tipo_doc_princ,
        dt_last_upd_ud_ko 
    from MON_V_ABIL_KEY_TOTAL_UD_KO 
    
), 
tmp_upd_unita_doc_ko as (
    select distinct 
        upd_ud_ko.id_strut,
        abil_key_ud_ko.id_user_iam,
        upd_ud_ko.cd_registro_key_unita_doc,
...
-- changeset root:1760715398880-330
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_STRUT.ID_STRUT IS 'PK.1 relativa a tabella ORG_STRUT';

-- changeset root:1760715398880-331
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_STRUT.ID_USER_IAM IS 'PK.2 relativa a tabella IAM_USER';

-- changeset root:1760715398880-332
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_STRUT.TI_STATO_SES_UPD_KO IS 'PK.3 - Stato della sessione di aggiornamento fallita';

-- changeset root:1760715398880-333
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_STRUT.NI_UPD_UD_KO IS 'Numero di aggiornamenti metadati falliti';

-- changeset root:1760715398880-334
CREATE OR REPLACE FORCE VIEW MON_V_CNT_UD_UPD_KO_ENTE (ID_ENTE, ID_USER_IAM, TI_STATO_SES_UPD_KO, NI_UPD_UD_KO) AS with tmp_abil_key_ud_ko as (
    select 
        id_key_total_ud_ko, 
        id_ente, 
        id_strut, 
...
select  
    upd_ko.id_ente, 
    upd_ko.id_user_iam,
    upd_ko.ti_stato_ses_upd_ko, 
    count(*) ni_upd_ud_ko 
from tmp_upd_unita_doc_ko upd_ko   
group by upd_ko.id_ente, 
         upd_ko.id_user_iam,
         upd_ko.ti_stato_ses_upd_ko;

-- changeset root:1760715398880-335
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_ENTE.ID_ENTE IS 'PK.1 relativa a tabella ORG_ENTE';

-- changeset root:1760715398880-336
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_ENTE.ID_USER_IAM IS 'PK.2 relativa a tabella IAM_USER';

-- changeset root:1760715398880-337
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_ENTE.TI_STATO_SES_UPD_KO IS 'PK.3 - Stato della sessione di aggiornamento fallita';

-- changeset root:1760715398880-338
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_ENTE.NI_UPD_UD_KO IS 'Numero di aggiornamenti metadati falliti';

-- changeset root:1760715398880-339
CREATE OR REPLACE FORCE VIEW MON_V_CNT_UD_UPD_KO_AMB (ID_AMBIENTE, ID_USER_IAM, TI_STATO_SES_UPD_KO, NI_UPD_UD_KO) AS with tmp_abil_key_ud_ko as (
    select 
        id_key_total_ud_ko, 
        id_ambiente, 
        id_strut, 
...
select  
    ...
    count(*) ni_upd_ud_ko 
from tmp_upd_unita_doc_ko upd_ko   
group by upd_ko.id_ambiente, 
         upd_ko.id_user_iam,
         upd_ko.ti_stato_ses_upd_ko;

-- changeset root:1760715398880-340
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_AMB.ID_AMBIENTE IS 'PK.1 relativa a tabella ORG_AMBIENTE';

-- changeset root:1760715398880-341
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_AMB.ID_USER_IAM IS 'PK.2 relativa a tabella IAM_USER';

-- changeset root:1760715398880-342
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_AMB.TI_STATO_SES_UPD_KO IS 'PK.3 - Stato della sessione di aggiornamento fallita';

-- changeset root:1760715398880-343
COMMENT ON COLUMN MON_V_CNT_UD_UPD_KO_AMB.NI_UPD_UD_KO IS 'Numero di aggiornamenti metadati falliti';

-- changeset root:1760715398880-344
CREATE SEQUENCE SARO_DUP_RICH_SOFT_DELETE START WITH 526064 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1760715398880-345
CREATE SEQUENCE SARO_ERR_RICH_SOFT_DELETE START WITH 5144 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1760715398880-346
CREATE SEQUENCE SARO_ITEM_RICH_SOFT_DELETE START WITH 131944 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1760715398880-347
CREATE SEQUENCE SARO_LOG_RICH_SOFT_DELETE START WITH 1934724 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1760715398880-348
CREATE SEQUENCE SARO_RICH_SOFT_DELETE START WITH 5384 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1760715398880-349
CREATE SEQUENCE SARO_STATO_RICH_SOFT_DELETE START WITH 5384 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1760715398880-350
CREATE SEQUENCE SARO_XML_RICH_SOFT_DELETE START WITH 5384 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1760715398880-351
CREATE SEQUENCE SDM_UD_DEL_RICHIESTE START WITH 21 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1760715398880-352
...
-- changeset root:1760715398880-353
...
-- changeset root:1760715398880-354
...
-- changeset root:1760715398880-355
...
-- changeset root:1760715398880-356
...
-- changeset root:1760715398880-357
...
-- changeset root:1760715398880-358
...
-- changeset root:1760715398880-359
...
-- changeset root:1760715398880-360
...
-- changeset root:1760715398880-361
...
-- changeset root:1760715398880-362
...
-- changeset root:1760715398880-363
...
-- changeset root:1760715398880-364
...
-- changeset root:1760715398880-365
...
-- changeset root:1760715398880-366
...
-- changeset root:1760715398880-367
...
-- changeset root:1760715398880-368
...
-- changeset root:1760715398880-369
...
-- changeset root:1760715398880-370
...
-- changeset root:1760715398880-371
...
-- changeset root:1760715398880-372
...
-- changeset root:1760715398880-373
...
-- changeset root:1760715398880-374
...
-- changeset root:1760715398880-375
...
-- changeset root:1760715398880-376
...
-- changeset root:1760715398880-377
...
-- changeset root:1760715398880-378
...
-- changeset root:1760715398880-379
...
-- changeset root:1760715398880-380
...
-- changeset root:1760715398880-381
...
-- changeset root:1760715398880-382
...
-- changeset root:1760715398880-383
...
-- changeset root:1760715398880-386
...
-- changeset root:1760715398880-387
...
-- changeset root:1760715398880-388
...
-- changeset root:1760715398880-389
...
-- changeset root:1760715398880-390
...
-- changeset root:1760715398880-391
...
-- changeset root:1760715398880-392
...
-- changeset root:1760715398880-393
...
-- changeset root:1760715398880-394
...
-- changeset root:1760715398880-395
...
-- changeset root:1760715398880-396
...
-- changeset root:1760715398880-397
...
-- changeset root:1760715398880-398
...
-- changeset root:1760715398880-399
...
-- changeset root:1760715398880-400
...
-- changeset root:1760715398880-401
...
-- changeset root:1760715398880-402
...
-- changeset root:1760715398880-403
...
-- changeset root:1760715398880-404
...
-- changeset root:1760715398880-405
...
-- changeset root:1760715398880-406
...
-- changeset root:1760715398880-407
...
-- changeset root:1760715398880-408
...
-- changeset root:1760715398880-409
...
-- changeset root:1760715398880-410
...
-- changeset root:1760715398880-411
...
-- changeset root:1760715398880-412
...
-- changeset root:1760715398880-413
...
-- changeset root:1760715398880-414
...
-- changeset root:1760715398880-415
...
-- changeset root:1760715398880-419
...
-- changeset root:1760715398880-420
...
-- changeset root:1760715398880-421
...
-- changeset root:1760715398880-422
...
-- changeset root:1760715398880-423
CREATE TABLE TMP_XML_EMPTY (ID_STRUT NUMBER, NUMERO NUMBER);

-- changeset root:1760715398880-424
...
-- changeset root:1760715398880-425
...
-- changeset root:1760715398880-426
...
-- changeset root:1760715398880-427
...
-- changeset root:1760715398880-428
...
-- changeset root:1760715398880-429
...
-- changeset root:1760715398880-430
...
-- changeset root:1760715398880-431
...
-- changeset root:1760715398880-710
...
-- changeset root:1760715398880-711
...
-- changeset root:1760715398880-712
...
-- changeset root:1760715398880-713
...
-- changeset root:1760715398880-769
...
-- changeset root:1760715398880-770
...
-- changeset root:1760715398880-933
...
-- changeset root:1760715398880-934
...
-- changeset root:1760715398880-935
...
-- changeset root:1760715398880-936
...
-- changeset root:1760715398880-937
...
-- changeset root:1760715398880-938
...
-- changeset root:1760715398880-939
...
-- changeset root:1760715398880-940
...
-- changeset root:1760715398880-941
...
-- changeset root:1760715398880-942
...
-- changeset root:1760715398880-943
...
-- changeset root:1760715398880-944
...
-- changeset root:1760715398880-945
...
-- changeset root:1760715398880-946
...
-- changeset root:1760715398880-947
...
-- changeset root:1760715398880-948
...
-- changeset root:1760715398880-949
...
-- changeset root:1760715398880-950
...
-- changeset root:1760715398880-951
...
-- changeset root:1760715398880-952
...
-- changeset root:1760715398880-953
...
-- changeset root:1760715398880-954
...
-- changeset root:1760715398880-955
...
-- changeset root:1760715398880-956
...
-- changeset root:1760715398880-957
...
-- changeset root:1760715398880-958
...
-- changeset root:1760715398880-959
...
-- changeset root:1760715398880-962
...
-- changeset root:1760715398880-963
...
-- changeset root:1760715398880-964
...
-- changeset root:1760715398880-965
...
-- changeset root:1760715398880-966
...
-- changeset root:1760715398880-967
ALTER TABLE DM_UD_DEL_BATCH_JOBS ADD CONSTRAINT FK_UD_DEL_BATCH_JOBS FOREIGN KEY (ID_UD_DEL_RICHIESTA) REFERENCES DM_UD_DEL_RICHIESTE (ID_UD_DEL_RICHIESTA);

-- changeset root:1760715398880-968
ALTER TABLE DM_UD_DEL ADD CONSTRAINT FK_UD_DEL_RICHIESTA FOREIGN KEY (ID_UD_DEL_RICHIESTA) REFERENCES DM_UD_DEL_RICHIESTE (ID_UD_DEL_RICHIESTA);

-- changeset root:1760715398880-969
...
-- changeset root:1760715398880-970
...
-- changeset root:1760715398880-971
...
-- changeset root:1760715398880-972
...
-- changeset root:1760715398880-973
...
-- changeset root:1760715398880-974
...
-- changeset root:1760715398880-975
...
-- changeset root:1760715398880-976
...
-- changeset root:1760715398880-977
...
-- changeset root:1760715398880-4
...
-- changeset root:1760715398880-6
...
-- changeset root:1760715398880-8
...
-- changeset root:1760715398880-10
...
-- changeset root:1760715398880-12
...
-- changeset root:1760715398880-14
...
-- changeset root:1760715398880-16
...
-- changeset root:1760715398880-18
...
-- changeset root:1760715398880-20
...
-- changeset root:1760715398880-22
...
-- changeset root:1760715398880-34
...
-- changeset root:1760715398880-36
...
-- changeset root:1760715398880-38
...
-- changeset root:1760715398880-40
...
-- changeset root:1760715398880-123
...
-- changeset root:1760715398880-129
...
-- changeset root:1760715398880-135
...
-- changeset root:1760715398880-150
...
-- changeset root:1760715398880-165
...
-- changeset root:1760715398880-174
...
-- changeset root:1760715398880-180
...
-- changeset root:1760715398880-183
...
-- changeset root:1760715398880-186
...
-- changeset root:1760715398880-189
...
-- changeset root:1760715398880-207
...
-- changeset root:1760715398880-254
...
-- changeset root:1760715398880-269
...
case
	when exists (select * 
				 ...
				 where item_non_annul.id_rich_annul_vers = rich.id_rich_annul_vers
				 and item_non_annul.ti_stato_item = 'DA_ANNULLARE_IN_PING'
				)
		then '1'
		else '0'
end fl_annul_ping,
...
case
	when exists (select * 
				 from ARO_ITEM_RICH_ANNUL_VERS item_non_annul
				 where item_non_annul.id_rich_annul_vers = rich.id_rich_annul_vers
				 and item_non_annul.ti_stato_item = 'NON_ANNULLABILE'
				)
		then '1'
		else '0'
end fl_non_annul,
...
(
    -- Conteggio da ARO_ITEM_RICH_ANNUL_VERS
    (select count(*)
    ...
    (select count(*)
     ...
     where ud_rich.ID_RICHIESTA = rich.id_rich_annul_vers AND ud_rich.ti_mot_cancellazione = 'A' AND ud_del.ti_stato_ud_cancellate = 'CANCELLATA_DB_SACER')
) ni_item,
...
-- changeset root:1760715398880-270
...
-- changeset root:1760715398880-271
...
-- changeset root:1760715398880-272
...
-- changeset root:1760715398880-273
...
-- changeset root:1760715398880-274
...
-- changeset root:1760715398880-275
...
-- changeset root:1760715398880-276
...
-- changeset root:1760715398880-277
...
-- changeset root:1760715398880-278
...
-- changeset root:1760715398880-279
...
-- changeset root:1760715398880-280
...
-- changeset root:1760715398880-281
...
-- changeset root:1760715398880-282
...
-- changeset root:1760715398880-283
...
-- changeset root:1760715398880-284
...
-- changeset root:1760715398880-285
...
-- changeset root:1760715398880-286
...
-- changeset root:1760715398880-287
CREATE OR REPLACE FORCE VIEW MON_V_CNT_UD_ANNUL_ENTE (ID_ENTE, ID_USER_IAM, TI_STATO_ANNUL, TI_DT_CREAZIONE, NI_ANNUL) AS select
...
-- changeset root:1760715398880-288
CREATE OR REPLACE FORCE VIEW MON_V_CNT_UD_ANNUL_STRUT (ID_STRUT, TI_STATO_ANNUL, TI_DT_CREAZIONE, NI_ANNUL) AS select
 item_annul.id_strut, 
 case
	when item_annul.ti_stato_item = 'DA_ANNULLARE_IN_PING' then 'DA_FARE_PING'
	when item_annul.ti_stato_item = 'DA_ANNULLARE_IN_SACER' then 'DA_FARE_SACER'
...
-- changeset root:1760715398880-289
...
-- changeset root:1760715398880-290
...
-- changeset root:1760715398880-291
...
-- changeset root:1760715398880-292
...
-- changeset root:1760715398880-293
...
-- changeset root:1760715398880-294
...
-- changeset root:1760715398880-295
...
-- changeset root:1760715398880-296
...
-- changeset root:1760715398880-297
...
-- changeset root:1760715398880-298
...
-- changeset root:1760715398880-299
...
-- changeset root:1760715398880-300

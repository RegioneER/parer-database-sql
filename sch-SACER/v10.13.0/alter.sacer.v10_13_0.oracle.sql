...
-- changeset root:1770026991905-341
...
-- changeset root:1770026991905-342
...
-- changeset root:1770026991905-343
...
-- changeset root:1770026991905-344
...
-- changeset root:1770026991905-345
...
-- changeset root:1770026991905-346
CREATE TABLE ARO_RIC_RICH_RA_FOTO (ID_ENTE_CONVENZ NUMBER NOT NULL, NM_ENTE_CONVENZ VARCHAR2(254 BYTE) NOT NULL, NM_ENTE_STRUT VARCHAR2(203 BYTE), ID_RICHIESTA_RA NUMBER NOT NULL, ID_AMBIENTE NUMBER NOT NULL, ID_ENTE NUMBER NOT NULL, ID_STRUT NUMBER, TOTALI NUMBER, ESTRATTI NUMBER, ERRORI NUMBER, SUM_DIM NUMBER(20, 2), MAX_DT_ESTRAZIONE date, TI_STATO VARCHAR2(30 BYTE) NOT NULL, ESTRATTI_TOTALI NUMBER(10, 2), CD_ERRORE VARCHAR2(300 BYTE), TS_INIZIO TIMESTAMP(6) NOT NULL, ID_RIC_RICH_RA_FOTO NUMBER GENERATED ALWAYS AS IDENTITY NOT NULL, CONSTRAINT PK_ID_RIC_RICH_RA_FOTO PRIMARY KEY (ID_RIC_RICH_RA_FOTO));

-- changeset root:1770026991905-347
CREATE TABLE ARO_LIS_ITEM_RA_FOTO (ID_RICHIESTA_RA NUMBER NOT NULL, ID_STRUT NUMBER, ANNO NUMBER(4, 0) NOT NULL, TOT_UD NUMBER, NUM_AIP NUMBER, DIMENSIONE NUMBER(20, 2), NUM_DOCS NUMBER, NUM_ERRORI NUMBER, NUM_ESTRATTI NUMBER, AVANZAMENTO NUMBER(10, 2), ID_LIS_ITEM_RA_FOTO NUMBER GENERATED ALWAYS AS IDENTITY NOT NULL, CONSTRAINT PK_ID_LIS_ITEM_RA_FOTO PRIMARY KEY (ID_LIS_ITEM_RA_FOTO));

-- changeset root:1770026991905-348
CREATE TABLE ARO_ERR_RICH_SCARTO_VERS (ID_ERR_RICH_SCARTO_VRS NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL, ID_ITEM_RICH_SCARTO_VERS NUMBER NOT NULL, PG_ERR NUMBER NOT NULL, TI_ERR VARCHAR2(30 BYTE) NOT NULL, DS_ERR VARCHAR2(4000 BYTE) NOT NULL, TI_GRAVITA VARCHAR2(20 BYTE) NOT NULL, TS_SOFT_DELETE TIMESTAMP(6), DM_SOFT_DELETE VARCHAR2(4000 BYTE), CONSTRAINT PK_ERR_RICH_SCARTO_VRS PRIMARY KEY (ID_ERR_RICH_SCARTO_VRS));

-- changeset root:1770026991905-349
CREATE TABLE ARO_RICH_SCARTO_VERS (ID_RICH_SCARTO_VERS NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL, ID_STRUT NUMBER NOT NULL, CD_RICH_SCARTO_VERS VARCHAR2(200 BYTE) NOT NULL, DS_RICH_SCARTO_VERS VARCHAR2(254 BYTE) NOT NULL, NT_RICH_SCARTO_VERS VARCHAR2(2000 BYTE) NOT NULL, DT_CREAZIONE_RICH_SCARTO_VERS date NOT NULL, ID_STATO_RICH_SCARTO_VERS_COR NUMBER, TI_CREAZIONE_RICH_SCARTO_VERS VARCHAR2(30 BYTE) NOT NULL, TS_SOFT_DELETE TIMESTAMP(6), DM_SOFT_DELETE VARCHAR2(4000 BYTE), CONSTRAINT PK_RICH_SCARTO_VRS PRIMARY KEY (ID_RICH_SCARTO_VERS));

-- changeset root:1770026991905-350
CREATE TABLE ARO_ITEM_RICH_SCARTO_VERS (ID_ITEM_RICH_SCARTO_VERS NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL, ID_RICH_SCARTO_VERS NUMBER NOT NULL, PG_ITEM_RICH_SCARTO_VERS NUMBER NOT NULL, ID_STRUT NUMBER NOT NULL, CD_REGISTRO_KEY_UNITA_DOC VARCHAR2(100 BYTE), AA_KEY_UNITA_DOC NUMBER(4, 0), CD_KEY_UNITA_DOC VARCHAR2(100 BYTE), TI_STATO_ITEM_SCARTO VARCHAR2(30 BYTE) NOT NULL, ID_UNITA_DOC NUMBER, TS_SOFT_DELETE TIMESTAMP(6), DM_SOFT_DELETE VARCHAR2(4000 BYTE), CONSTRAINT PK_ITEM_RICH_SCARTO_VRS PRIMARY KEY (ID_ITEM_RICH_SCARTO_VERS));

-- changeset root:1770026991905-351
CREATE TABLE ARO_STATO_RICH_SCARTO_VERS (ID_STATO_RICH_SCARTO_VERS NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL, ID_RICH_SCARTO_VERS NUMBER NOT NULL, PG_STATO_RICH_SCARTO_VERS NUMBER NOT NULL, DT_REG_STATO_RICH_SCARTO_VERS date NOT NULL, DS_NOTA_RICH_SCARTO_VERS VARCHAR2(1024 BYTE), TI_STATO_RICH_SCARTO_VERS VARCHAR2(30 BYTE) NOT NULL, ID_USER_IAM NUMBER NOT NULL, CONSTRAINT PK_STATO_RICH_SCARTO_VRS PRIMARY KEY (ID_STATO_RICH_SCARTO_VERS));

-- changeset root:1770026991905-352
...
-- changeset root:1770026991905-353
...
-- changeset root:1770026991905-354
COMMENT ON COLUMN ARO_V_LIS_ITEM_RICH_SCARTO.ID_ITEM_RICH_SCARTO_VERS IS 'PK.1';

-- changeset root:1770026991905-355
...
-- changeset root:1770026991905-356
...
-- changeset root:1770026991905-357
...
-- changeset root:1770026991905-358
...
-- changeset root:1770026991905-359
COMMENT ON COLUMN ARO_V_RIC_RICH_SCARTO.ID_USER_IAM IS 'PK.1';

-- changeset root:1770026991905-360
COMMENT ON COLUMN ARO_V_RIC_RICH_SCARTO.ID_RICH_SCARTO_VERS IS 'PK.2';

-- changeset root:1770026991905-361
COMMENT ON COLUMN ARO_V_RIC_RICH_SCARTO.ID_ITEM_RICH_SCARTO_VERS IS 'PK.3';

-- changeset root:1770026991905-362
...
-- changeset root:1770026991905-363
COMMENT ON COLUMN ARO_V_VIS_RICH_SCARTO.ID_RICH_SCARTO_VERS IS 'PK.1';

-- changeset root:1770026991905-364
...
-- changeset root:1770026991905-365
COMMENT ON COLUMN ARO_V_VIS_STATO_RICH_SCARTO.ID_STATO_RICH_SCARTO_VERS IS 'PK.1';

-- changeset root:1770026991905-366
...
-- changeset root:1770026991905-369
...
-- changeset root:1770026991905-370
...
-- changeset root:1770026991905-371
COMMENT ON COLUMN ARO_V_LIS_STATO_RICH_SCARTO.ID_STATO_RICH_SCARTO_VERS IS 'PK.1';

-- changeset root:1770026991905-372
...
-- changeset root:1770026991905-373
...
-- changeset root:1770026991905-377
...
-- changeset root:1770026991905-378
...
-- changeset root:1770026991905-379
...
-- changeset root:1770026991905-380
...
-- changeset root:1770026991905-381
...
-- changeset root:1770026991905-382
...
-- changeset root:1770026991905-383
...
-- changeset root:1770026991905-384
...
-- changeset root:1770026991905-385
CREATE TABLE ARO_FILE_RICH_SCARTO_VERS (ID_FILE_RICH_SCARTO_VERS NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY NOT NULL, ID_RICH_SCARTO_VERS NUMBER NOT NULL, TI_FILE VARCHAR2(30 BYTE) NOT NULL, BL_FILE CLOB NOT NULL, CONSTRAINT PK_FILE_RICH_SCARTO_VRS PRIMARY KEY (ID_FILE_RICH_SCARTO_VERS));

-- changeset root:1770026991905-386
...
-- changeset root:1770026991905-387
...
-- changeset root:1770026991905-388
...
-- changeset root:1770026991905-389
...
-- changeset root:1770026991905-390
...
-- changeset root:1770026991905-391
...
-- changeset root:1770026991905-392
...
-- changeset root:1770026991905-393
CREATE TABLE ARO_XML_RICH_SCARTO_VERS (ID_XML_RICH_SCARTO_VERS NUMBER NOT NULL, ID_RICH_SCARTO_VERS NUMBER NOT NULL, TI_XML_RICH_SCARTO_VERS VARCHAR2(20 BYTE) NOT NULL, BL_XML_RICH_SCARTO_VERS CLOB NOT NULL, CD_VERSIONE_XML VARCHAR2(100 BYTE) NOT NULL, CONSTRAINT PK_XML_RICH_SCARTO_VRS PRIMARY KEY (ID_XML_RICH_SCARTO_VERS));

-- changeset root:1770026991905-394
...
-- changeset root:1770026991905-395
...
-- changeset root:1770026991905-396
...
-- changeset root:1770026991905-397
...
-- changeset root:1770026991905-398
...
-- changeset root:1770026991905-399
...
-- changeset root:1770026991905-400
...
-- changeset root:1770026991905-401
...
-- changeset root:1770026991905-402
...
-- changeset root:1770026991905-403
...
-- changeset root:1770026991905-404
...
-- changeset root:1770026991905-405
...
-- changeset root:1770026991905-406
...
-- changeset root:1770026991905-407
...
-- changeset root:1770026991905-408
...
-- changeset root:1770026991905-409
...
-- changeset root:1770026991905-410
...
-- changeset root:1770026991905-411
...
-- changeset root:1770026991905-412
...
-- changeset root:1770026991905-413
...
-- changeset root:1770026991905-414
...
-- changeset root:1770026991905-415
...
-- changeset root:1770026991905-418
...
-- changeset root:1770026991905-419
...
-- changeset root:1770026991905-420
...
-- changeset root:1770026991905-421
...
-- changeset root:1770026991905-422
...
-- changeset root:1770026991905-423
...
-- changeset root:1770026991905-424
...
-- changeset root:1770026991905-425
...
-- changeset root:1770026991905-426
...
-- changeset root:1770026991905-427
...
-- changeset root:1770026991905-428
...
-- changeset root:1770026991905-429
...
-- changeset root:1770026991905-430
...
-- changeset root:1770026991905-431
...
-- changeset root:1770026991905-432
...
-- changeset root:1770026991905-433
...
-- changeset root:1770026991905-434
...
-- changeset root:1770026991905-435
...
-- changeset root:1770026991905-436
...
-- changeset root:1770026991905-437
...
-- changeset root:1770026991905-438
...
-- changeset root:1770026991905-439
...
-- changeset root:1770026991905-440
...
-- changeset root:1770026991905-441
...
-- changeset root:1770026991905-442
...
-- changeset root:1770026991905-443
...
-- changeset root:1770026991905-444
...
-- changeset root:1770026991905-445
...
-- changeset root:1770026991905-446
...
-- changeset root:1770026991905-447
...
-- changeset root:1770026991905-448
...
-- changeset root:1770026991905-449
...
-- changeset root:1770026991905-450
...
-- changeset root:1770026991905-451
...
-- changeset root:1770026991905-452
...
-- changeset root:1770026991905-453
...
-- changeset root:1770026991905-454
...
-- changeset root:1770026991905-455
...
-- changeset root:1770026991905-456
...
-- changeset root:1770026991905-457
...
-- changeset root:1770026991905-458
...
-- changeset root:1770026991905-459
...
-- changeset root:1770026991905-463
...
-- changeset root:1770026991905-464
...
-- changeset root:1770026991905-465
...
-- changeset root:1770026991905-466
...
-- changeset root:1770026991905-467
CREATE TABLE TMP_XML_EMPTY (ID_STRUT NUMBER, NUMERO NUMBER);

-- changeset root:1770026991905-468
...
-- changeset root:1770026991905-469
...
-- changeset root:1770026991905-470
...
-- changeset root:1770026991905-471
...
-- changeset root:1770026991905-472
...
-- changeset root:1770026991905-473
...
-- changeset root:1770026991905-474
...
-- changeset root:1770026991905-475
...
-- changeset root:1770026991905-476
...
-- changeset root:1770026991905-490
CREATE UNIQUE INDEX UN_ERR_RICH_SCARTO_VRS ON ARO_ERR_RICH_SCARTO_VERS(ID_ITEM_RICH_SCARTO_VERS, PG_ERR);

-- changeset root:1770026991905-491
ALTER TABLE ARO_ERR_RICH_SCARTO_VERS ADD CONSTRAINT UN_ERR_RICH_SCARTO_VRS UNIQUE (ID_ITEM_RICH_SCARTO_VERS, PG_ERR) USING INDEX UN_ERR_RICH_SCARTO_VRS;

-- changeset root:1770026991905-492
CREATE UNIQUE INDEX UN_ERR_SES_VRS ON VRS_ERR_SESSIONE_VERS_ORI(ID_DATI_SESSIONE_VERS, PG_ERR_SESSIONE_VERS);

-- changeset root:1770026991905-493
...
-- changeset root:1770026991905-496
CREATE UNIQUE INDEX UN_FILE_RICH_SCARTO_VRS ON ARO_FILE_RICH_SCARTO_VERS(ID_RICH_SCARTO_VERS, TI_FILE);

-- changeset root:1770026991905-497
ALTER TABLE ARO_FILE_RICH_SCARTO_VERS ADD CONSTRAINT UN_FILE_RICH_SCARTO_VRS UNIQUE (ID_RICH_SCARTO_VERS, TI_FILE) USING INDEX UN_FILE_RICH_SCARTO_VRS;

-- changeset root:1770026991905-498
CREATE UNIQUE INDEX UN_ITEM_RICH_SCARTO_VRS ON ARO_ITEM_RICH_SCARTO_VERS(ID_RICH_SCARTO_VERS, PG_ITEM_RICH_SCARTO_VERS);

-- changeset root:1770026991905-499
ALTER TABLE ARO_ITEM_RICH_SCARTO_VERS ADD CONSTRAINT UN_ITEM_RICH_SCARTO_VRS UNIQUE (ID_RICH_SCARTO_VERS, PG_ITEM_RICH_SCARTO_VERS) USING INDEX UN_ITEM_RICH_SCARTO_VRS;

-- changeset root:1770026991905-500
CREATE UNIQUE INDEX UN_NOTA_ELE_SEQ ON SEQ_NOTA_ELENCO_SEQUESTRO(ID_ELENCO_SEQUESTRO, PG_NOTA_ELENCO_SEQUESTRO);

-- changeset root:1770026991905-501
...
-- changeset root:1770026991905-502
CREATE UNIQUE INDEX UN_NOTA_SEQ ON SEQ_NOTA_SEQUESTRO(ID_SEQUESTRO, PG_NOTA_SEQUESTRO);

-- changeset root:1770026991905-503
ALTER TABLE SEQ_NOTA_SEQUESTRO ADD CONSTRAINT UN_NOTA_SEQ UNIQUE (ID_SEQUESTRO, PG_NOTA_SEQUESTRO) USING INDEX UN_NOTA_SEQ;

-- changeset root:1770026991905-504
CREATE UNIQUE INDEX UN_RICH_SCARTO_VRS ON ARO_RICH_SCARTO_VERS(ID_STRUT, CD_RICH_SCARTO_VERS);

-- changeset root:1770026991905-505
ALTER TABLE ARO_RICH_SCARTO_VERS ADD CONSTRAINT UN_RICH_SCARTO_VRS UNIQUE (ID_STRUT, CD_RICH_SCARTO_VERS) USING INDEX UN_RICH_SCARTO_VRS;

-- changeset root:1770026991905-506
CREATE UNIQUE INDEX UN_SEQ ON SEQ_SEQUESTRO(ID_STRUT, DS_SEQUESTRO);

-- changeset root:1770026991905-507
ALTER TABLE SEQ_SEQUESTRO ADD CONSTRAINT UN_SEQ UNIQUE (ID_STRUT, DS_SEQUESTRO) USING INDEX UN_SEQ;

-- changeset root:1770026991905-508
CREATE UNIQUE INDEX UN_STATO_ELE_SEQ ON SEQ_STATO_ELENCO_SEQUESTRO(ID_ELENCO_SEQUESTRO, PG_STATO_ELENCO_SEQUESTRO);

-- changeset root:1770026991905-509
...
-- changeset root:1770026991905-510
CREATE UNIQUE INDEX UN_STATO_RICH_SCARTO_VRS ON ARO_STATO_RICH_SCARTO_VERS(ID_RICH_SCARTO_VERS, PG_STATO_RICH_SCARTO_VERS);

-- changeset root:1770026991905-511
ALTER TABLE ARO_STATO_RICH_SCARTO_VERS ADD CONSTRAINT UN_STATO_RICH_SCARTO_VRS UNIQUE (ID_RICH_SCARTO_VERS, PG_STATO_RICH_SCARTO_VERS) USING INDEX UN_STATO_RICH_SCARTO_VRS;

-- changeset root:1770026991905-512
CREATE UNIQUE INDEX UN_STATO_SEQ ON SEQ_STATO_SEQUESTRO(ID_SEQUESTRO, PG_STATO_SEQUESTRO);

-- changeset root:1770026991905-513
...
-- changeset root:1770026991905-528
CREATE UNIQUE INDEX UN_XML_RICH_SCARTO_VRS ON ARO_XML_RICH_SCARTO_VERS(ID_RICH_SCARTO_VERS, TI_XML_RICH_SCARTO_VERS);

-- changeset root:1770026991905-529
ALTER TABLE ARO_XML_RICH_SCARTO_VERS ADD CONSTRAINT UN_XML_RICH_SCARTO_VRS UNIQUE (ID_RICH_SCARTO_VERS, TI_XML_RICH_SCARTO_VERS) USING INDEX UN_XML_RICH_SCARTO_VRS;

-- changeset root:1770026991905-530
CREATE INDEX IDX_DT_CHIUSURA ON VRS_SESSIONE_VERS_ORI(DT_CHIUSURA);

-- changeset root:1770026991905-531
CREATE INDEX IDX_DT_CHIUSURA_KO ON VRS_SESSIONE_VERS_KO(DT_CHIUSURA);

-- changeset root:1770026991905-532
CREATE INDEX IDX_DT_CHIUSURA_NEW2 ON VRS_SESSIONE_VERS(ID_STRUT, DT_CHIUSURA);

-- changeset root:1770026991905-533
CREATE INDEX IDX_FASC_FIRST ON FAS_FASCICOLO(ID_UNITA_DOC_FIRST);

-- changeset root:1770026991905-534
CREATE INDEX IDX_FASC_LAST ON FAS_FASCICOLO(ID_UNITA_DOC_LAST);

-- changeset root:1770026991905-535
CREATE INDEX IDX_ID_COMP_DOC ON ARO_COMP_VER_INDICE_AIP_UD(ID_COMP_DOC);

-- changeset root:1770026991905-536
CREATE INDEX IDX_ID_DOC ON ARO_WARN_UNITA_DOC(ID_DOC);

-- changeset root:1770026991905-537
CREATE INDEX IDX_ID_FASCICOLO_TEST ON FAS_XML_FASCICOLO(ID_FASCICOLO);

-- changeset root:1770026991905-538
CREATE INDEX IDX_ID_STRUT_MIGRAZ ON ARO_COMP_DOC_DA_MIGRARE_OS(ID_STRUT);

-- changeset root:1770026991905-539
CREATE INDEX IDX_ID_STRUT_SES_VRS_KO ON VRS_SESSIONE_VERS_KO(ID_STRUT);

-- changeset root:1770026991905-540
CREATE INDEX IDX_IS_STRUT_NEW ON ARO_COMP_DOC(ID_STRUT);

-- changeset root:1770026991905-541
...
-- changeset root:1770026991905-549
...
-- changeset root:1770026991905-550
...
-- changeset root:1770026991905-586
...
-- changeset root:1770026991905-587
...
-- changeset root:1770026991905-588
...
-- changeset root:1770026991905-589
...
-- changeset root:1770026991905-590
ALTER TABLE ARO_ERR_RICH_SCARTO_VERS ADD CONSTRAINT FK_ERR_RICH_SCARTO_VRS_ITEM FOREIGN KEY (ID_ITEM_RICH_SCARTO_VERS) REFERENCES ARO_ITEM_RICH_SCARTO_VERS (ID_ITEM_RICH_SCARTO_VERS) ON DELETE CASCADE;

-- changeset root:1770026991905-591
...
-- changeset root:1770026991905-592
...
-- changeset root:1770026991905-593
ALTER TABLE ARO_FILE_RICH_SCARTO_VERS ADD CONSTRAINT FK_FILE_RICH_SCARTO_VRS FOREIGN KEY (ID_RICH_SCARTO_VERS) REFERENCES ARO_RICH_SCARTO_VERS (ID_RICH_SCARTO_VERS) ON DELETE CASCADE;

-- changeset root:1770026991905-594
ALTER TABLE ARO_ITEM_RICH_SCARTO_VERS ADD CONSTRAINT FK_ITEM_RICH_SCARTO_VERS FOREIGN KEY (ID_UNITA_DOC) REFERENCES ARO_UNITA_DOC (ID_UNITA_DOC);

-- changeset root:1770026991905-595
ALTER TABLE ARO_ITEM_RICH_SCARTO_VERS ADD CONSTRAINT FK_ITEM_RICH_SCARTO_VRS FOREIGN KEY (ID_RICH_SCARTO_VERS) REFERENCES ARO_RICH_SCARTO_VERS (ID_RICH_SCARTO_VERS) ON DELETE CASCADE;

-- changeset root:1770026991905-596
...
-- changeset root:1770026991905-597
...
-- changeset root:1770026991905-598
...
-- changeset root:1770026991905-599
...
-- changeset root:1770026991905-600
...
-- changeset root:1770026991905-601
ALTER TABLE ARO_RICH_SCARTO_VERS ADD CONSTRAINT FK_RICH_SCARTO_VERS_STRUT FOREIGN KEY (ID_STRUT) REFERENCES ORG_STRUT (ID_STRUT) ON DELETE CASCADE;

-- changeset root:1770026991905-602
...
-- changeset root:1770026991905-603
...
-- changeset root:1770026991905-604
...
-- changeset root:1770026991905-605
ALTER TABLE ARO_STATO_RICH_SCARTO_VERS ADD CONSTRAINT FK_STATO_RICH_SCARTO_VRS FOREIGN KEY (ID_RICH_SCARTO_VERS) REFERENCES ARO_RICH_SCARTO_VERS (ID_RICH_SCARTO_VERS) ON DELETE CASCADE;

-- changeset root:1770026991905-606
ALTER TABLE ARO_STATO_RICH_SCARTO_VERS ADD CONSTRAINT FK_STATO_RICH_SCARTO_VRS_USR FOREIGN KEY (ID_USER_IAM) REFERENCES IAM_USER (ID_USER_IAM);

-- changeset root:1770026991905-607
...
-- changeset root:1770026991905-610
...
-- changeset root:1770026991905-611
...
-- changeset root:1770026991905-612
...
-- changeset root:1770026991905-613
...
-- changeset root:1770026991905-614
...
-- changeset root:1770026991905-615
...
-- changeset root:1770026991905-616
...
-- changeset root:1770026991905-617
...
-- changeset root:1770026991905-618
...
-- changeset root:1770026991905-619
...
-- changeset root:1770026991905-620
...
-- changeset root:1770026991905-621
...
-- changeset root:1770026991905-622
...
-- changeset root:1770026991905-623
ALTER TABLE ARO_XML_RICH_SCARTO_VERS ADD CONSTRAINT FK_XML_RICH_SCARTO_VRS FOREIGN KEY (ID_RICH_SCARTO_VERS) REFERENCES ARO_RICH_SCARTO_VERS (ID_RICH_SCARTO_VERS) ON DELETE CASCADE;

-- changeset root:1770026991905-624
...
-- changeset root:1770026991905-627
...
-- changeset root:1770026991905-4
...
-- changeset root:1770026991905-6
...
-- changeset root:1770026991905-8
...
-- changeset root:1770026991905-10
...
-- changeset root:1770026991905-12
...
-- changeset root:1770026991905-14
...
-- changeset root:1770026991905-16
...
-- changeset root:1770026991905-18
...
-- changeset root:1770026991905-20
...
-- changeset root:1770026991905-22
...
-- changeset root:1770026991905-24
...
-- changeset root:1770026991905-36
...
-- changeset root:1770026991905-38
...
-- changeset root:1770026991905-40
...
-- changeset root:1770026991905-42
...
-- changeset root:1770026991905-149
...
-- changeset root:1770026991905-158
...
-- changeset root:1770026991905-164
...
-- changeset root:1770026991905-179
...
-- changeset root:1770026991905-194
...
-- changeset root:1770026991905-203
...
-- changeset root:1770026991905-209
...
-- changeset root:1770026991905-212
...
-- changeset root:1770026991905-215
...
-- changeset root:1770026991905-218
...
-- changeset root:1770026991905-239
...
-- changeset root:1770026991905-292
...
-- changeset root:1770026991905-307
CREATE OR REPLACE FORCE VIEW ARO_V_CHK_STATO_COR_RICH_SOFT_DELETE (ID_RICHIESTA_SACER, TI_ITEM_RICH_SOFT_DELETE, FL_RICH_IN_ELABORAZIONE, FL_RICH_EVASA_OK, FL_RICH_EVASA_KO_RECUP, FL_RICH_EVASA_KO_GEST, FL_RICH_ACQUISIZIONE_KO, FL_RICH_ERRORE) AS SELECT
    item_rich.id_richiesta_sacer,
    item_rich.ti_item_rich_soft_delete,
    
    -- FL_RICH_IN_ELABORAZIONE: Usiamo MAX. Se anche solo una parte è in elaborazione, la richiesta è "in elaborazione".
    MAX(
        case
    ...
    ) as fl_rich_in_elaborazione,

    -- FL_RICH_EVASA_OK: Usiamo MIN!
    -- Se ho due record, uno OK ('1') e uno KO ('0'), MIN restituirà '0'.
    -- Restituisce '1' SOLO se tutti i record sono '1'.
    MIN(
        case
            ...
            then
                case
                   when not exists (select 1
                                from ARO_ITEM_RICH_SOFT_DELETE rich_item
                                where rich_item.id_rich_soft_delete = rich.id_rich_soft_delete
                                and rich_item.TI_stato_item IN ('DA_ELABORARE', 'ERRORE_ELABORAZIONE', 'NON_ELABORABILE')
                                )
                    then '1'
                   else '0'
                end
    ...
    -- FL_RICH_EVASA_KO_RECUP: Usiamo MAX (basta un errore per accendere il flag)
    MAX(
        case
          when stato_rich.ti_stato_rich_soft_delete IN ('EVASA')
            then
    ...
    ) as fl_rich_evasa_ko_recup,
 
    -- FL_RICH_EVASA_KO_GEST: Usiamo MAX (basta un errore per accendere il flag)
    MAX(
        case
          when stato_rich.ti_stato_rich_soft_delete IN ('EVASA')
            then
    ...
    ) as fl_rich_evasa_ko_gest,
  
    -- FL_RICH_ACQUISIZIONE_KO: Usiamo MAX
    MAX(
        case
    ...
    ) as fl_rich_acquisizione_ko,
 
    -- FL_RICH_ERRORE: Usiamo MAX
    MAX(
        case
...
GROUP BY item_rich.id_richiesta_sacer, item_rich.ti_item_rich_soft_delete;

-- changeset root:1770026991905-308
...
-- changeset root:1770026991905-309
CREATE OR REPLACE FORCE VIEW ARO_V_RIC_RICH_RA (ID_ENTE_CONVENZ, NM_ENTE_CONVENZ, NM_ENTE_STRUT, ID_RICHIESTA_RA, ID_AMBIENTE, ID_ENTE, ID_STRUT, TOTALI, ESTRATTI, ERRORI, SUM_DIM, MAX_DT_ESTRAZIONE, TI_STATO, ESTRATTI_TOTALI, CD_ERRORE, TS_INIZIO) AS SELECT /*+ parallel */
    ...
    SELECT ID_ENTE_CONVENZ,
           ...
           CD_ERRORE,
           TS_INIZIO
      FROM aro_ric_rich_ra_foto;

-- changeset root:1770026991905-310
...
-- changeset root:1770026991905-311
...
-- changeset root:1770026991905-312
...
-- changeset root:1770026991905-313
...
-- changeset root:1770026991905-314
...
-- changeset root:1770026991905-315
...
-- changeset root:1770026991905-316
...
-- changeset root:1770026991905-317
...
-- changeset root:1770026991905-318
...
-- changeset root:1770026991905-319
...
-- changeset root:1770026991905-320
...
-- changeset root:1770026991905-321
...
-- changeset root:1770026991905-322
      ...
      FROM ARO_RICH_ANNUL_VERS  rich_ann
           JOIN ARO_ITEM_RICH_ANNUL_VERS item
               ON (    item.id_rich_annul_vers = rich_ann.id_rich_annul_vers
                   AND item.ti_item_rich_annul_vers = 'UNI_DOC'
                   AND item.ti_stato_item = 'DA_ANNULLARE_IN_SACER')
           JOIN ARO_UNITA_DOC ud ON (ud.id_unita_doc = item.id_unita_doc)
           JOIN ARO_DOC doc
               ON (    doc.id_unita_doc = ud.id_unita_doc
                   AND doc.ti_creazione = 'AGGIUNTA_DOCUMENTO'
                   AND doc.ti_stato_doc_elenco_vers IN
                           ('IN_ELENCO_CHIUSO',
                            'IN_ELENCO_FIRMATO',
                            'IN_ELENCO_IN_CODA_INDICE_AIP',
                            'IN_ELENCO_CON_INDICI_AIP_GENERATI',
      ...
      FROM ARO_RICH_ANNUL_VERS  rich_ann
           ...
           JOIN ARO_UPD_UNITA_DOC upd
               ON (    upd.id_unita_doc = ud.id_unita_doc
                   AND upd.ti_stato_upd_elenco_vers IN
                           ('IN_ELENCO_CHIUSO',
                            'IN_ELENCO_FIRMATO',
                            'IN_ELENCO_IN_CODA_INDICE_AIP',
                            'IN_ELENCO_CON_INDICI_AIP_GENERATI',
...
-- changeset root:1770026991905-323
...
-- changeset root:1770026991905-324
...
-- changeset root:1770026991905-325
CREATE OR REPLACE FORCE VIEW ELV_V_RIC_ELENCO_VERS_BY_STATO (ID_ELENCO_VERS, ID_AMBIENTE, NM_AMBIENTE, ID_ENTE, NM_ENTE, ID_STRUT, NM_STRUT, ID_USER_IAM, NM_ELENCO, DS_ELENCO, TI_STATO_ELENCO, DT_CREAZIONE_ELENCO, DT_CHIUS, DT_FIRMA_INDICE, NI_COMP_VERS_ELENCO, NI_COMP_AGG_ELENCO, NI_SIZE_VERS_ELENCO, NI_SIZE_AGG_ELENCO, NT_INDICE_ELENCO, NT_ELENCO_CHIUSO, ID_CRITERIO_RAGGR, NM_CRITERIO_RAGGR, DT_CREAZIONE_ELENCO_IX_AIP, DT_FIRMA_ELENCO_IX_AIP, FL_ELENCO_FISC, FL_ELENCO_STANDARD, NI_INDICI_AIP, TI_GEST_ELENCO, TI_VALID_ELENCO, TI_MOD_VALID_ELENCO, FL_ELENCO_FIRMATO, TS_STATO_ELENCO_IN_CODA_JMS, HH_STATO_ELENCO_IN_CODA_JMS) AS SELECT ele.id_elenco_vers,
           ...
           END                                                                fl_elenco_firmato,
           daelab.ts_stato_elenco                                             ts_stato_elenco_in_coda_jms,
             EXTRACT (HOUR FROM SYSTIMESTAMP - daelab.ts_stato_elenco)
           + 24 * EXTRACT (DAY FROM SYSTIMESTAMP - daelab.ts_stato_elenco)    hh_stato_elenco_in_coda_jms
...
-- changeset root:1770026991905-326
CREATE OR REPLACE FORCE VIEW ELV_V_RIC_ELENCO_VERS_BY_UD (ID_ELENCO_VERS, ID_AMBIENTE, NM_AMBIENTE, ID_ENTE, NM_ENTE, ID_STRUT, NM_STRUT, ID_USER_IAM, NM_ELENCO, DS_ELENCO, TI_STATO_ELENCO, DT_CREAZIONE_ELENCO, DT_CHIUS, DT_FIRMA_INDICE, NI_COMP_VERS_ELENCO, NI_COMP_AGG_ELENCO, NI_SIZE_VERS_ELENCO, NI_SIZE_AGG_ELENCO, NT_INDICE_ELENCO, NT_ELENCO_CHIUSO, ID_CRITERIO_RAGGR, NM_CRITERIO_RAGGR, ID_UNITA_DOC, ID_STRUT_UNI_DOC, ID_REGISTRO_UNITA_DOC, CD_REGISTRO_KEY_UNITA_DOC, AA_KEY_UNITA_DOC, CD_KEY_UNITA_DOC, DT_CREAZIONE_ELENCO_IX_AIP, DT_FIRMA_ELENCO_IX_AIP, FL_ELENCO_FISC, FL_ELENCO_STANDARD, NI_INDICI_AIP, TI_GEST_ELENCO, TI_VALID_ELENCO, TI_MOD_VALID_ELENCO, FL_ELENCO_FIRMATO, TS_STATO_ELENCO_IN_CODA_JMS) AS SELECT ele.id_elenco_vers,
           ...
           ele.id_criterio_raggr,
           crit.nm_criterio_raggr,
           ud_vers.id_unita_doc,
           ud_vers.id_strut,
           ud_vers.id_registro_unita_doc,
           ud_vers.cd_registro_key_unita_doc,
           ud_vers.aa_key_unita_doc,
           ud_vers.cd_key_unita_doc,
           ele.dt_creazione_elenco_ix_aip,
           ele.dt_firma_elenco_ix_aip,
           ele.fl_elenco_fisc,
           ele.fl_elenco_standard,
    ...
    SELECT ele.id_elenco_vers,
      ...
      FROM ELV_ELENCO_VERS  ele
           ...
           JOIN ARO_UNITA_DOC ud ON (ud.id_unita_doc = doc_agg.id_unita_doc)
           LEFT JOIN ELV_ELENCO_VERS_DA_ELAB daelab
               ON (daelab.id_elenco_vers = ele.id_elenco_vers)
    UNION
    SELECT ele.id_elenco_vers,
...
-- changeset root:1770026991905-327
...
-- changeset root:1770026991905-328
...
-- changeset root:1770026991905-329
...
-- changeset root:1770026991905-330
...
-- changeset root:1770026991905-331
...
-- changeset root:1770026991905-332
...
-- changeset root:1770026991905-333
...
-- changeset root:1770026991905-334
...
-- changeset root:1770026991905-335
...
-- changeset root:1770026991905-336
...
-- changeset root:1770026991905-337
CREATE OR REPLACE FORCE VIEW ORG_V_LIS_STRUT_PER_ELE (FL_PRESENZA_ELENCO_FISC, ID_STRUT) AS SELECT '1' fl_presenza_elenco_fisc, strut.id_strut
      FROM ORG_STRUT strut
     WHERE EXISTS
               (SELECT *
                 ...
                 WHERE     ele_daelab.id_strut = strut.id_strut
                       AND ele_daelab.ti_stato_elenco IN
										   
														   
																	 
                               ('VALIDATO', 'IN_CODA_JMS_INDICE_AIP_DA_ELAB')
                       AND ele.fl_elenco_fisc = '1')
    UNION
    SELECT '0' fl_presenza_elenco_fisc, strut.id_strut
      FROM ORG_STRUT strut
     WHERE     NOT EXISTS
                   (SELECT *
                      FROM ELV_ELENCO_VERS_DA_ELAB  ele_daelab
                           JOIN ELV_ELENCO_VERS ele
                               ON (ele.id_elenco_vers =
                                   ele_daelab.id_elenco_vers)
                     WHERE     ele_daelab.id_strut = strut.id_strut
                           AND ele_daelab.ti_stato_elenco IN
                                   ('VALIDATO',
...
-- changeset root:1770026991905-338
...
-- changeset root:1770026991905-339

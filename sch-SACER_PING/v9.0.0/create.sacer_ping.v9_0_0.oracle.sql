...
-- changeset root:1773338200414-1
...
-- changeset root:1773338200414-2
...
-- changeset root:1773338200414-3
...
-- changeset root:1773338200414-4
...
-- changeset root:1773338200414-5
...
-- changeset root:1773338200414-6
...
-- changeset root:1773338200414-7
...
-- changeset root:1773338200414-8
...
-- changeset root:1773338200414-9
...
-- changeset root:1773338200414-10
...
-- changeset root:1773338200414-11
...
-- changeset root:1773338200414-12
...
-- changeset root:1773338200414-13
...
-- changeset root:1773338200414-14
...
-- changeset root:1773338200414-15
...
-- changeset root:1773338200414-16
...
-- changeset root:1773338200414-17 splitStatements:true
...
-- changeset root:1773338200414-18
...
-- changeset root:1773338200414-19
...
-- changeset root:1773338200414-20
...
-- changeset root:1773338200414-21
...
-- changeset root:1773338200414-22
...
-- changeset root:1773338200414-23
...
-- changeset root:1773338200414-24
...
-- changeset root:1773338200414-25
...
-- changeset root:1773338200414-26
...
-- changeset root:1773338200414-27
...
-- changeset root:1773338200414-28
...
-- changeset root:1773338200414-29
...
-- changeset root:1773338200414-30
...
-- changeset root:1773338200414-31
...
-- changeset root:1773338200414-32
...
-- changeset root:1773338200414-33
...
-- changeset root:1773338200414-34
...
-- changeset root:1773338200414-35
...
-- changeset root:1773338200414-36
...
-- changeset root:1773338200414-37
...
-- changeset root:1773338200414-38
...
-- changeset root:1773338200414-39
...
-- changeset root:1773338200414-40
...
-- changeset root:1773338200414-41
...
-- changeset root:1773338200414-42
...
-- changeset root:1773338200414-43
...
-- changeset root:1773338200414-47
...
-- changeset root:1773338200414-48
...
-- changeset root:1773338200414-49
...
-- changeset root:1773338200414-50
...
-- changeset root:1773338200414-51 splitStatements:true
...
-- changeset root:1773338200414-52 splitStatements:true
...
-- changeset root:1773338200414-53
...
-- changeset root:1773338200414-54
...
-- changeset root:1773338200414-55
...
-- changeset root:1773338200414-56
...
-- changeset root:1773338200414-57
...
-- changeset root:1773338200414-58
...
-- changeset root:1773338200414-59
...
-- changeset root:1773338200414-60
...
-- changeset root:1773338200414-61
...
-- changeset root:1773338200414-62
...
-- changeset root:1773338200414-63
...
-- changeset root:1773338200414-68
...
CREATE OR REPLACE FORCE VIEW "MON_V_LIS_STATO_VERS" ("ID_USER_IAM", "ID_AMBIENTE_VERS", "NM_AMBIENTE_VERS", "ID_TIPO_OBJECT", "NM_TIPO_OBJECT", "TI_VERS_FILE", "ID_VERS", "NM_VERS", "ID_OBJECT", "CD_KEY_OBJECT", "DS_OBJECT", "TI_STATO_ESTERNO", "TI_STATO_CALCOLATO", "TI_STATO_VISUALIZZATO", "ID_FILE_OBJECT", "NI_BYTE_FILE_VERS", "DS_HASH_FILE_VERS", "ID_SESSIONE_INGEST", "DT_VERS", "ID_USER_IAM_VERS", "NM_USERID_VERS", "TI_STATO_OBJECT", "NI_UD_PRODOTTE", "TI_GEST_OGGETTI_FIGLI", "NOTE", "TI_CONTENUTO_OGGETTO", "ID_TRASFORMAZIONE") AS SELECT 
    ...
    CASE
        WHEN ti_obj.ti_vers_file = 'ZIP_CON_XML_SACER' THEN 
            CASE
                WHEN ti_stato_object IN ('CHIUSO_ERR_SCHED') AND ses_cor.ti_stato_verifica_hash = 'KO' THEN 'Errore impronta'
                WHEN ti_stato_object IN ('CHIUSO_ERR_SCHED') AND ses_cor.ti_stato_verifica_hash = 'OK' THEN 'Errore preparazione versamento'
                WHEN ti_stato_object IN ('CHIUSO_ERR','CHIUSO_ERR_NOTIF') THEN 'Errore trasmissione'
                WHEN ti_stato_object IN ('CHIUSO_ERR_VERS') THEN 'Errore versamento'
                WHEN ti_stato_object IN ('IN_ATTESA_FILE') THEN 'In attesa file'
                WHEN ti_stato_object IN ('IN_ATTESA_VERS','IN_CODA_VERS','CHIUSO_ERR_CODA','CHIUSO_ERR_RECUPERABILE') THEN 'In corso di elaborazione'
                WHEN ti_stato_object IN ('IN_ATTESA_SCHED') THEN 'Trasmesso'
                WHEN ti_stato_object IN ('CHIUSO_OK') THEN 'Versato'
                WHEN ti_stato_object IN ('CHIUSO_ERR_CRASH_FTP','CHIUSO_ERR_CRASH_FS_PRIM','CHIUSO_ERR_CRASH_FS_SECOND') THEN 'Crash area FTP o file system'
                WHEN ti_stato_object IN ('ANNULLATO') THEN 'Annullato'
                WHEN ti_stato_object IN ('IN_CORSO_ANNULLAMENTO') THEN 'In corso di annullamento'
            END
       ELSE 
            CASE
                WHEN ti_stato_object IN ('TRASFORMAZIONE_NON_ATTIVA') THEN 'Da elaborare'
                WHEN ti_stato_object IN ('CHIUSO_ERR_TRASFORMAZIONE','CHIUSO_ERR_VERSAMENTO_A_PING') THEN 'Errore elaborazione'
                WHEN ti_stato_object IN ('CHIUSO_ERR_SCHED') THEN 'Errore impronta'
                WHEN ti_stato_object IN ('CHIUSO_ERR','CHIUSO_ERR_NOTIF') THEN 'Errore trasmissione'
                WHEN ti_stato_object IN ('CHIUSO_ERR_VERS') THEN 'Errore versamento'
                WHEN ti_stato_object IN ('IN_ATTESA_FILE') THEN 'In attesa file'
                WHEN ti_stato_object IN ('TRASFORMAZIONE_IN_CORSO','PREPARAZIONE_OGG_IN_CORSO','TRASFORMATO','VERSATO_A_PING','ERRORE_TRASFORMAZIONE','WARNING_TRASFORMAZIONE','ERRORE_VERSAMENTO_A_PING') THEN 'In corso di elaborazione'
                WHEN ti_stato_object IN ('IN_ATTESA_SCHED','DA_TRASFORMARE') THEN 'Trasmesso'
                WHEN ti_stato_object IN ('CHIUSO_OK') THEN 'Versato'
                WHEN ti_stato_object IN ('CHIUSO_ERR_CRASH_FTP','CHIUSO_ERR_CRASH_FS_PRIM','CHIUSO_ERR_CRASH_FS_SECOND') THEN 'Crash area FTP o file system'
                WHEN ti_stato_object IN ('ANNULLATO') THEN 'Annullato'
                WHEN ti_stato_object IN ('IN_CORSO_ANNULLAMENTO') THEN 'In corso di annullamento'
    ...
    CASE
        WHEN ti_obj.ti_vers_file = 'DA_TRASFORMARE' THEN
            CASE
                    ...
                    ELSE
                        CASE
                            WHEN EXISTS (SELECT 1
                                            ...
                                            WHERE obj_figlio.id_object_padre = obj.id_object
                                            AND obj_figlio.ti_stato_object in ('CHIUSO_ERR_SCHED', 'CHIUSO_ERR_CODA', 'CHIUSO_ERR_VERS')
                                            FETCH FIRST 1 ROW ONLY) THEN 'PROBLEMA_VERS_SACER'
                            ELSE
                                CASE
                                    WHEN EXISTS (SELECT 1
                                                    FROM PIG_UNITA_DOC_OBJECT ud
                                                    INNER JOIN PIG_OBJECT figlio ON figlio.id_object_padre = obj.id_object AND ud.id_object = figlio.id_object
                                                    WHERE ti_stato_unita_doc_object = 'VERSATA_ERR'
                                                        AND cd_err_sacer IN ('UD-002','UD-002-001')
                                                        FETCH FIRST 1 ROW ONLY) THEN 'WARNING_CHIAVE_DUPLICATA'
                                ELSE 
                                    'CHIUSO_OK'
                                END
                            END
                ...
                ELSE 
                    CASE 
                        WHEN EXISTS (SELECT 1 FROM PIG_OBJECT figlio
                                        WHERE figlio.id_object_padre = obj.id_object
                                        AND figlio.ti_stato_object IN ('IN_ATTESA_SCHED','IN_CODA_HASH')
                                        FETCH FIRST 1 ROW ONLY) THEN 'VERSATO_A_PING'
                        ELSE 
                            CASE 
                                WHEN EXISTS (SELECT 1 FROM PIG_OBJECT figlio
                                                WHERE figlio.id_object_padre = obj.id_object
                                                AND figlio.ti_stato_object IN ('CHIUSO_ERR_SCHED')
                                                FETCH FIRST 1 ROW ONLY) THEN 'PROBLEMA_PREPARAZIONE_SIP'
                            ELSE 
                                CASE
                                    WHEN EXISTS (SELECT 1 FROM PIG_OBJECT figlio
                                                    WHERE figlio.id_object_padre = obj.id_object
            ...
            ELSE 
                CASE 
                    WHEN obj.ti_stato_object = 'CHIUSO_OK' THEN 
                        CASE
                            WHEN EXISTS (SELECT 1 FROM PIG_UNITA_DOC_OBJECT ud
                                            WHERE ud.id_object = obj.id_object
                                            AND ti_stato_unita_doc_object = 'VERSATA_ERR'
                                                AND cd_err_sacer IN ('UD-002','UD-002-001')
                                                FETCH FIRST 1 ROW ONLY) THEN 'WARNING_CHIAVE_DUPLICATA'
                    ...
                    ELSE
                        CASE
                            WHEN EXISTS (SELECT 1 FROM PIG_OBJECT obj_figlio
                                            WHERE obj_figlio.id_object_padre = obj.id_object
                                            AND obj_figlio.ti_stato_object IN ('CHIUSO_ERR_SCHED', 'CHIUSO_ERR_CODA', 'CHIUSO_ERR_VERS')
                                            FETCH FIRST 1 ROW ONLY) THEN 'CHIUSO_OK (PROBLEMA_VERS_SACER)'
                        ELSE
                            CASE
                                WHEN EXISTS (SELECT 1 FROM PIG_UNITA_DOC_OBJECT ud
                                                INNER JOIN PIG_OBJECT figlio ON figlio.id_object_padre = obj.id_object AND ud.id_object = figlio.id_object
                                                WHERE ti_stato_unita_doc_object = 'VERSATA_ERR'
                                                        AND cd_err_sacer IN ('UD-002','UD-002-001')
                                                        FETCH FIRST 1 ROW ONLY) THEN 'CHIUSO_OK (WARNING_CHIAVE_DUPLICATA)'
                            ELSE 
                                'CHIUSO_OK'
                            END
                        END
                ...
                ELSE
                    CASE
                        WHEN EXISTS (SELECT 1 FROM PIG_OBJECT figlio
                                        WHERE figlio.id_object_padre = obj.id_object
                                        AND figlio.ti_stato_object IN ('CHIUSO_ERR_SCHED')
                                        FETCH FIRST 1 ROW ONLY) THEN 'VERSATO_A_PING (PROBLEMA_PREPARAZIONE_SIP)'
                    ELSE
                        CASE
                            WHEN EXISTS  (SELECT 1 FROM PIG_OBJECT figlio 
                                            WHERE figlio.id_object_padre = obj.id_object
                                            AND figlio.ti_stato_object IN ('CHIUSO_ERR_CODA', 'CHIUSO_ERR_VERS')
                                            FETCH FIRST 1 ROW ONLY) THEN 'VERSATO_A_PING (PROBLEMA_VERS_SACER)'
                        ELSE
                            'VERSATO_A_PING (IN_CORSO_VERS_SACER)'
                        END
                    END
                END
            END
...
-- changeset root:1773338200414-74
...
-- changeset root:1773338200414-83
...
-- changeset root:1773338200414-84
COMMENT ON COLUMN MON_V_VIS_OBJ_TRASF.ID_OBJECT_TRASF IS 'PK.1';

-- changeset root:1773338200414-85
...
-- changeset root:1773338200414-93
...
-- changeset root:1773338200414-96
COMMENT ON COLUMN USR_V_CHK_USER_CANC_PING.ID_USER_IAM IS 'PK.1';

-- changeset root:1773338200414-97
...
-- changeset root:1773338200414-108
...
-- changeset root:1773338200414-111
...
-- changeset root:1773338200414-139
COMMENT ON COLUMN APL_V_PARAM_APPLIC.NM_PARAM_APPLIC IS 'PK.1';

-- changeset root:1773338200414-140
...
-- changeset root:1773338200414-155
COMMENT ON COLUMN PIG_V_CHK_ORG_VERS_SACER.ID_OBJECT IS 'PK.1';

-- changeset root:1773338200414-156
...
-- changeset root:1773338200414-157
COMMENT ON COLUMN PIG_V_CHK_SES_PREC_NOT_ANNUL.ID_OBJECT IS 'PK.1';

-- changeset root:1773338200414-158
...
-- changeset root:1773338200414-159
...
-- changeset root:1773338200414-160
COMMENT ON COLUMN PIG_V_CHK_SIMULA_VERS_SACER.ID_OBJECT IS 'PK.1';

-- changeset root:1773338200414-161
...
-- changeset root:1773338200414-162
COMMENT ON COLUMN MON_V_CHK_OBJ_TERMINATO.ID_OBJECT IS 'PK.1';

-- changeset root:1773338200414-163
...
-- changeset root:1773338200414-179
COMMENT ON COLUMN PIG_V_SISMA_CHECKS.ID_SISMA IS 'PK.1';

-- changeset root:1773338200414-180
...
-- changeset root:1773338200414-181
CREATE OR REPLACE FORCE VIEW "PIG_V_VALORE_SET_PARAM_TRASF" ("ID_VERS_TIPO_OBJECT_DA_TRASF", "ID_SET_PARAM_TRASF", "NM_SET_PARAM_TRASF", "ID_VALORE_SET_PARAM_TRASF", "DS_LISTA_VALORE_PARAM") AS SELECT
    ...
    LISTAGG(tmp.nm_param_trasf || ' = ' || tmp.val_param, CHR(10)  ON OVERFLOW TRUNCATE) WITHIN GROUP(ORDER BY tmp.nm_param_trasf) AS ds_lista_valore_param
FROM
    (
        SELECT
            id_vers_tipo_object_da_trasf,
...
-- changeset root:1773338200414-191
COMMENT ON COLUMN APL_V_RANGE_MBYTE_CODA.NI_LIMITE_INF IS 'PK.1';

-- changeset root:1773338200414-192
...
-- changeset root:1773338200414-193
...
-- changeset root:1773338200414-194
...
-- changeset root:1773338200414-195
...
-- changeset root:1773338200414-196
...
-- changeset root:1773338200414-197
...
-- changeset root:1773338200414-200
...
-- changeset root:1773338200414-201
...
-- changeset root:1773338200414-202
...
-- changeset root:1773338200414-203
...
-- changeset root:1773338200414-204
...
-- changeset root:1773338200414-205
...
-- changeset root:1773338200414-206
...
-- changeset root:1773338200414-207
...
-- changeset root:1773338200414-208
...
-- changeset root:1773338200414-209
...
-- changeset root:1773338200414-210
...
-- changeset root:1773338200414-211
...
-- changeset root:1773338200414-212
...
-- changeset root:1773338200414-213
...
-- changeset root:1773338200414-214
...
-- changeset root:1773338200414-215
...
-- changeset root:1773338200414-216
...
-- changeset root:1773338200414-217
...
-- changeset root:1773338200414-218
...
-- changeset root:1773338200414-219
...
-- changeset root:1773338200414-220
...
-- changeset root:1773338200414-221
...
-- changeset root:1773338200414-222
...
-- changeset root:1773338200414-223
...
-- changeset root:1773338200414-224
...
-- changeset root:1773338200414-225
...
-- changeset root:1773338200414-226
...
-- changeset root:1773338200414-227
...
-- changeset root:1773338200414-228
...
-- changeset root:1773338200414-229
...
-- changeset root:1773338200414-230
...
-- changeset root:1773338200414-231
...
-- changeset root:1773338200414-232
...
-- changeset root:1773338200414-233
...
-- changeset root:1773338200414-234
...
-- changeset root:1773338200414-235
...
-- changeset root:1773338200414-236
...
-- changeset root:1773338200414-237
...
-- changeset root:1773338200414-238
...
-- changeset root:1773338200414-239
...
-- changeset root:1773338200414-240
...
-- changeset root:1773338200414-241
...
-- changeset root:1773338200414-242
...
-- changeset root:1773338200414-243
...
-- changeset root:1773338200414-244
...
-- changeset root:1773338200414-245
...
-- changeset root:1773338200414-246
...
-- changeset root:1773338200414-247
...
-- changeset root:1773338200414-248
...
-- changeset root:1773338200414-249
...
-- changeset root:1773338200414-250
...
-- changeset root:1773338200414-251
...
-- changeset root:1773338200414-252
...
-- changeset root:1773338200414-253
...
-- changeset root:1773338200414-254
...
-- changeset root:1773338200414-255
...
-- changeset root:1773338200414-256
...
-- changeset root:1773338200414-257
...
-- changeset root:1773338200414-258
...
-- changeset root:1773338200414-259
...
-- changeset root:1773338200414-260
...
-- changeset root:1773338200414-261
...
-- changeset root:1773338200414-262
...
-- changeset root:1773338200414-263
...
-- changeset root:1773338200414-264
...
-- changeset root:1773338200414-265
...
-- changeset root:1773338200414-266
...
-- changeset root:1773338200414-267
...
-- changeset root:1773338200414-268
...
-- changeset root:1773338200414-269
...
-- changeset root:1773338200414-270
...
-- changeset root:1773338200414-271
...
-- changeset root:1773338200414-272
...
-- changeset root:1773338200414-273 splitStatements:true
...
-- changeset root:1773338200414-274 splitStatements:true
...
-- changeset root:1773338200414-275 splitStatements:true
...
-- changeset root:1773338200414-276 splitStatements:true
...
-- changeset root:1773338200414-277 splitStatements:true
...
-- changeset root:1773338200414-278
...
-- changeset root:1773338200414-279 splitStatements:true
...
-- changeset root:1773338200414-280 splitStatements:true
...
-- changeset root:1773338200414-281 splitStatements:true
...
-- changeset root:1773338200414-282 splitStatements:true
...
-- changeset root:1773338200414-283 splitStatements:true
...
-- changeset root:1773338200414-284 splitStatements:true
...
-- changeset root:1773338200414-285 splitStatements:true
...
-- changeset root:1773338200414-286 splitStatements:true
...
-- changeset root:1773338200414-287 splitStatements:true
...
-- changeset root:1773338200414-288 splitStatements:true
...
-- changeset root:1773338200414-289 splitStatements:true
...
-- changeset root:1773338200414-290 splitStatements:true
...
-- changeset root:1773338200414-291
...
-- changeset root:1773338200414-292
...
-- changeset root:1773338200414-293 splitStatements:true
...
-- changeset root:1773338200414-294 splitStatements:true
...
-- changeset root:1773338200414-295 splitStatements:true
...
-- changeset root:1773338200414-296 splitStatements:true
...
-- changeset root:1773338200414-297
...
-- changeset root:1773338200414-298
...
-- changeset root:1773338200414-299
...
-- changeset root:1773338200414-300
...
-- changeset root:1773338200414-301
...
-- changeset root:1773338200414-302
...
-- changeset root:1773338200414-303
...
-- changeset root:1773338200414-304
...
-- changeset root:1773338200414-305
...
-- changeset root:1773338200414-306
...
-- changeset root:1773338200414-307
...
-- changeset root:1773338200414-308
...
-- changeset root:1773338200414-309
...
-- changeset root:1773338200414-310
...
-- changeset root:1773338200414-311
...
-- changeset root:1773338200414-312
...
-- changeset root:1773338200414-313
...
-- changeset root:1773338200414-314
...
-- changeset root:1773338200414-315
...
-- changeset root:1773338200414-316
...
-- changeset root:1773338200414-317
...
-- changeset root:1773338200414-318
...
-- changeset root:1773338200414-319
...
-- changeset root:1773338200414-320
...
-- changeset root:1773338200414-321
...
-- changeset root:1773338200414-322
...
-- changeset root:1773338200414-323
...
-- changeset root:1773338200414-324
...
-- changeset root:1773338200414-325
...
-- changeset root:1773338200414-326
...
-- changeset root:1773338200414-331
...
-- changeset root:1773338200414-332
...
-- changeset root:1773338200414-333
...
-- changeset root:1773338200414-336
...
-- changeset root:1773338200414-355
...
-- changeset root:1773338200414-356
...
-- changeset root:1773338200414-424
...
-- changeset root:1773338200414-425
...
-- changeset root:1773338200414-426
...
-- changeset root:1773338200414-506
...
-- changeset root:1773338200414-507
...
-- changeset root:1773338200414-508
...
-- changeset root:1773338200414-509
...
-- changeset root:1773338200414-510
...
-- changeset root:1773338200414-511
...
-- changeset root:1773338200414-512
...
-- changeset root:1773338200414-513
...
-- changeset root:1773338200414-514
...
-- changeset root:1773338200414-515
...
-- changeset root:1773338200414-516
...
-- changeset root:1773338200414-517
...
-- changeset root:1773338200414-518
...
-- changeset root:1773338200414-521
...
-- changeset root:1773338200414-522
...
-- changeset root:1773338200414-523
...
-- changeset root:1773338200414-524
...
-- changeset root:1773338200414-525
...
-- changeset root:1773338200414-526
...
-- changeset root:1773338200414-527
...
-- changeset root:1773338200414-528
...
-- changeset root:1773338200414-529
...
-- changeset root:1773338200414-530
...
-- changeset root:1773338200414-531
...
-- changeset root:1773338200414-532
...
-- changeset root:1773338200414-533
...
-- changeset root:1773338200414-534
...
-- changeset root:1773338200414-535
...
-- changeset root:1773338200414-536
...
-- changeset root:1773338200414-537
...
-- changeset root:1773338200414-538
...
-- changeset root:1773338200414-539
...
-- changeset root:1773338200414-540
...
-- changeset root:1773338200414-541
...
-- changeset root:1773338200414-542
...
-- changeset root:1773338200414-543
...
-- changeset root:1773338200414-544
...
-- changeset root:1773338200414-545
...
-- changeset root:1773338200414-546
...
-- changeset root:1773338200414-547
...
-- changeset root:1773338200414-548
...
-- changeset root:1773338200414-549
...
-- changeset root:1773338200414-550
...
-- changeset root:1773338200414-555
...
-- changeset root:1773338200414-556
...
-- changeset root:1773338200414-557
...
-- changeset root:1773338200414-558
...
-- changeset root:1773338200414-559
...
-- changeset root:1773338200414-560
...
-- changeset root:1773338200414-561
...
-- changeset root:1773338200414-562
...
-- changeset root:1773338200414-563
...
-- changeset root:1773338200414-564
...
-- changeset root:1773338200414-565
...
-- changeset root:1773338200414-566
...
-- changeset root:1773338200414-567
...
-- changeset root:1773338200414-568
...
-- changeset root:1773338200414-569
...
-- changeset root:1773338200414-570
...
-- changeset root:1773338200414-571
...
-- changeset root:1773338200414-572
...
-- changeset root:1773338200414-576
...
-- changeset root:1773338200414-577
...
-- changeset root:1773338200414-578
...
-- changeset root:1773338200414-579
...
-- changeset root:1773338200414-580
...
-- changeset root:1773338200414-581
...
-- changeset root:1773338200414-582
...
-- changeset root:1773338200414-583
...
-- changeset root:1773338200414-584
...
-- changeset root:1773338200414-585
...
-- changeset root:1773338200414-586
...
-- changeset root:1773338200414-587
...
-- changeset root:1773338200414-588
...
-- changeset root:1773338200414-589
...
-- changeset root:1773338200414-590
...
-- changeset root:1773338200414-591
...
-- changeset root:1773338200414-592
...
-- changeset root:1773338200414-593
...
-- changeset root:1773338200414-594
...
-- changeset root:1773338200414-595
...
-- changeset root:1773338200414-596
...
-- changeset root:1773338200414-597
...
-- changeset root:1773338200414-598
...
-- changeset root:1773338200414-599
...
-- changeset root:1773338200414-600
...
-- changeset root:1773338200414-601
...
-- changeset root:1773338200414-602
...
-- changeset root:1773338200414-603
...
-- changeset root:1773338200414-604
...
-- changeset root:1773338200414-605
...
-- changeset root:1773338200414-606

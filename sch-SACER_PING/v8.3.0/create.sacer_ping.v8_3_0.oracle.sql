...
-- changeset root:1770027412470-1
...
-- changeset root:1770027412470-2
...
-- changeset root:1770027412470-3
...
-- changeset root:1770027412470-4
...
-- changeset root:1770027412470-5
...
-- changeset root:1770027412470-6
...
-- changeset root:1770027412470-7
...
-- changeset root:1770027412470-8
...
-- changeset root:1770027412470-9
...
-- changeset root:1770027412470-10
CREATE SEQUENCE SPIG_VALORE_PARAM_APPLIC START WITH 1541 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-11
...
-- changeset root:1770027412470-12
...
-- changeset root:1770027412470-13
...
-- changeset root:1770027412470-14
...
-- changeset root:1770027412470-15
...
-- changeset root:1770027412470-16
...
-- changeset root:1770027412470-17 splitStatements:true
...
-- changeset root:1770027412470-18
...
-- changeset root:1770027412470-19
...
-- changeset root:1770027412470-20
...
-- changeset root:1770027412470-21
...
-- changeset root:1770027412470-22
...
-- changeset root:1770027412470-23
...
-- changeset root:1770027412470-24
...
-- changeset root:1770027412470-25
...
-- changeset root:1770027412470-26
...
-- changeset root:1770027412470-27
...
-- changeset root:1770027412470-28
...
-- changeset root:1770027412470-29
...
-- changeset root:1770027412470-30
...
-- changeset root:1770027412470-31
...
-- changeset root:1770027412470-32
CREATE TABLE PIG_VALORE_PARAM_TRASF (ID_VALORE_PARAM_TRASF NUMBER NOT NULL, ID_VALORE_SET_PARAM_TRASF NUMBER NOT NULL, ID_PARAM_TRASF NUMBER NOT NULL, DS_VALORE_PARAM VARCHAR2(4000 BYTE), CONSTRAINT PK_VAL_PAR_TRASF PRIMARY KEY (ID_VALORE_PARAM_TRASF));

-- changeset root:1770027412470-33
...
-- changeset root:1770027412470-34
...
-- changeset root:1770027412470-35
...
-- changeset root:1770027412470-36
...
-- changeset root:1770027412470-37
...
-- changeset root:1770027412470-38
...
-- changeset root:1770027412470-39
...
-- changeset root:1770027412470-40
...
-- changeset root:1770027412470-41
...
-- changeset root:1770027412470-44
...
-- changeset root:1770027412470-45
...
-- changeset root:1770027412470-46
...
-- changeset root:1770027412470-47
...
-- changeset root:1770027412470-48
...
-- changeset root:1770027412470-49
...
-- changeset root:1770027412470-50
...
-- changeset root:1770027412470-51 splitStatements:true
...
-- changeset root:1770027412470-53
...
-- changeset root:1770027412470-54
...
-- changeset root:1770027412470-55
...
-- changeset root:1770027412470-56
...
-- changeset root:1770027412470-57
...
UD_ERR AS (
    ...
    FROM PIG_UNITA_DOC_OBJECT ud INNER JOIN PIG_OBJECT figlio ON ud.id_object = figlio.id_object
...
SELECT
    ...
    obj.ds_object,
    CASE
        WHEN ti_obj.ti_vers_file = 'ZIP_CON_XML_SACER' THEN
            CASE
                WHEN obj.ti_stato_object = 'CHIUSO_ERR_SCHED' AND ses_cor.ti_stato_verifica_hash = 'KO' THEN 'Errore impronta'
                WHEN obj.ti_stato_object = 'CHIUSO_ERR_SCHED' AND ses_cor.ti_stato_verifica_hash = 'OK' THEN 'Errore preparazione versamento'
                WHEN obj.ti_stato_object IN ('CHIUSO_ERR','CHIUSO_ERR_NOTIF') THEN 'Errore trasmissione'
                WHEN obj.ti_stato_object = 'CHIUSO_ERR_VERS' THEN 'Errore versamento'
                WHEN obj.ti_stato_object = 'IN_ATTESA_FILE' THEN 'In attesa file'
                WHEN obj.ti_stato_object IN ('IN_ATTESA_VERS','IN_CODA_VERS','CHIUSO_ERR_CODA','CHIUSO_ERR_RECUPERABILE') THEN 'In corso di elaborazione'
                WHEN obj.ti_stato_object = 'IN_ATTESA_SCHED' THEN 'Trasmesso'
                WHEN obj.ti_stato_object = 'CHIUSO_OK' THEN 'Versato'
                WHEN obj.ti_stato_object IN ('CHIUSO_ERR_CRASH_FTP','CHIUSO_ERR_CRASH_FS_PRIM','CHIUSO_ERR_CRASH_FS_SECOND') THEN 'Crash area FTP o file system'
                WHEN obj.ti_stato_object = 'ANNULLATO' THEN 'Annullato' 
                WHEN obj.ti_stato_object = 'IN_CORSO_ANNULLAMENTO' THEN 'In corso di annullamento'
            END
        ELSE
            CASE
                WHEN obj.ti_stato_object = 'TRASFORMAZIONE_NON_ATTIVA' THEN 'Da elaborare'
                WHEN obj.ti_stato_object IN ('CHIUSO_ERR_TRASFORMAZIONE','CHIUSO_ERR_VERSAMENTO_A_PING') THEN 'Errore elaborazione'
                WHEN obj.ti_stato_object = 'CHIUSO_ERR_SCHED' THEN 'Errore impronta'
                WHEN obj.ti_stato_object IN ('CHIUSO_ERR','CHIUSO_ERR_NOTIF') THEN 'Errore trasmissione'
                WHEN obj.ti_stato_object = 'CHIUSO_ERR_VERS' THEN 'Errore versamento'
                WHEN obj.ti_stato_object = 'IN_ATTESA_FILE' THEN 'In attesa file'
                WHEN obj.ti_stato_object IN ('TRASFORMAZIONE_IN_CORSO','PREPARAZIONE_OGG_IN_CORSO','TRASFORMATO','VERSATO_A_PING','ERRORE_TRASFORMAZIONE','WARNING_TRASFORMAZIONE','ERRORE_VERSAMENTO_A_PING') THEN 'In corso di elaborazione'
                WHEN obj.ti_stato_object IN ('IN_ATTESA_SCHED','DA_TRASFORMARE') THEN 'Trasmesso'
                WHEN obj.ti_stato_object = 'CHIUSO_OK' THEN 'Versato'
                WHEN obj.ti_stato_object IN ('CHIUSO_ERR_CRASH_FTP','CHIUSO_ERR_CRASH_FS_PRIM','CHIUSO_ERR_CRASH_FS_SECOND') THEN 'Crash area FTP o file system'
                WHEN obj.ti_stato_object = 'ANNULLATO' THEN 'Annullato'
                WHEN obj.ti_stato_object = 'IN_CORSO_ANNULLAMENTO' THEN 'In corso di annullamento'
            END
    END AS ti_stato_esterno,
    /*Per modificare o aggiungere stati vedi CROSS APPLY, c'è tutta la logica degli stati */
    s.ti_stato_base AS ti_stato_calcolato,
    /* Per modificare la descrizione dello stato in visualizzazione si prende lo stato oggetto e si concatena con lo stato calcolato s.ti_stato_base una sola volta*/
    CASE
        WHEN s.ti_stato_base IN ('PROBLEMA_VERS_SACER','WARNING_CHIAVE_DUPLICATA','PROBLEMA_PREPARAZIONE_SIP','IN_CORSO_VERS_SACER')
        THEN
            obj.ti_stato_object || ' (' || s.ti_stato_base || ')'
        ELSE
            s.ti_stato_base
    END AS ti_stato_visualizzato,    
    file_obj.id_file_object,
    file_obj.ni_size_file_vers,
    file_obj.ds_hash_file_vers,
    ses_cor.id_sessione_ingest,
    ses_cor.dt_apertura AS dt_vers,
    usr.id_user_iam AS id_user_iam_vers,
    usr.nm_userid AS nm_userid_vers,
    obj.ti_stato_object,
    COALESCE(ud_tot.totale,0) + COALESCE(fasc_tot.totale,0) AS ni_ud_prodotte,
...
INNER JOIN PIG_SESSIONE_INGEST ses_cor ON ses_cor.id_sessione_ingest = obj.id_last_sessione_ingest
INNER JOIN IAM_ABIL_ORGANIZ abil_organiz ON abil_organiz.id_organiz_applic = vers.id_vers
INNER JOIN IAM_ABIL_TIPO_DATO abil_dato ON abil_dato.id_abil_organiz = abil_organiz.id_abil_organiz AND abil_dato.nm_classe_tipo_dato = 'TIPO_OBJECT' AND abil_dato.id_tipo_dato_applic = ti_obj.id_tipo_object
LEFT JOIN IAM_USER usr ON usr.id_user_iam = obj.id_user_iam
LEFT JOIN PIG_FILE_OBJECT file_obj ON file_obj.id_object = obj.id_object
LEFT JOIN XFO_TRASF xfo_trasf ON xfo_trasf.id_trasf = ti_obj.id_trasf
...
LEFT JOIN UD_TOT ud_tot ON ud_tot.id_object = obj.id_object
LEFT JOIN FASC_TOT fasc_tot ON fasc_tot.id_object = obj.id_object
/* Gestione degli stati dell'oggetto */
CROSS APPLY (
SELECT
  CASE WHEN ti_obj.ti_vers_file = 'DA_TRASFORMARE' THEN
            CASE WHEN obj.ti_stato_object <> 'VERSATO_A_PING' THEN
                    CASE WHEN obj.ti_stato_object <> 'CHIUSO_OK' THEN obj.ti_stato_object
                    ELSE 
                            CASE WHEN flags.esiste_err_sched = 1 OR flags.esiste_err_vers = 1 THEN 'PROBLEMA_VERS_SACER'
                            ELSE
                                CASE WHEN EXISTS (SELECT 1 FROM ud_err WHERE ud_err.id_object_padre = obj.id_object AND ud_err.esiste_ud_dup = 1) 
                                        OR EXISTS (SELECT 1 FROM fasc_err WHERE fasc_err.id_object_padre = obj.id_object AND fasc_err.esiste_fasc_dup = 1) THEN 'WARNING_CHIAVE_DUPLICATA'
                                ELSE
                                    obj.ti_stato_object                                        
                                END
                            END
            ...
            ELSE
                    ...
                    ELSE
                            CASE WHEN flags.esiste_err_sched = 1 THEN 'PROBLEMA_PREPARAZIONE_SIP'
                            ELSE
                                    CASE WHEN flags.esiste_err_vers = 1 THEN 'PROBLEMA_VERS_SACER'
            ...
            END
    ELSE
        CASE WHEN obj.ti_stato_object = 'CHIUSO_OK' THEN
                CASE WHEN ud_err.esiste_ud_dup = 1 OR fasc_err.esiste_fasc_dup = 1 THEN 'WARNING_CHIAVE_DUPLICATA'
                ELSE obj.ti_stato_object
                END                
        ELSE
                obj.ti_stato_object
        END
    END AS ti_stato_base
    FROM dual
) s
WHERE 
    ti_obj.ti_vers_file IN ('DA_TRASFORMARE','ZIP_CON_XML_SACER')
    AND vers.fl_cessato = 0;

-- changeset root:1770027412470-59
...
-- changeset root:1770027412470-60
...
-- changeset root:1770027412470-61
...
-- changeset root:1770027412470-62
...
-- changeset root:1770027412470-63
...
-- changeset root:1770027412470-64
...
-- changeset root:1770027412470-67
COMMENT ON COLUMN MON_V_LIS_VERS_OBJ.ID_SESSIONE_INGEST IS 'PK.1 relativa a tabella PIG_SESSIONE_INGEST';

-- changeset root:1770027412470-68
CREATE OR REPLACE FORCE VIEW "MON_V_OBJ_RANGE_DT" ("ID_VERS", "ID_OBJECT", "CD_KEY_OBJECT", "ID_TIPO_OBJECT", "TI_STATO_OBJECT", "TI_DT_CREAZIONE", "TI_CLASSE_VERS_FILE") AS WITH 
/* 1. Versatori e multi versatori attivi */
MultiVersatori AS (
    SELECT 
        pv.id_vers as id_vers_padre, 
        pvt.id_vers_gen as id_vers_figlio
    FROM pig_vers pv 
    INNER JOIN pig_tipo_object pto ON pto.id_vers = pv.id_vers
    INNER JOIN pig_vers_tipo_object_da_trasf pvt ON pvt.id_tipo_object_da_trasf = pto.id_tipo_object
    WHERE pv.fl_cessato = 0 AND pv.id_vers <> pvt.id_vers_gen
    UNION ALL
    SELECT pv1.id_vers, pv1.id_vers 
    FROM pig_vers pv1 
    WHERE pv1.fl_cessato = 0
),
/* 2. Stati oggetti figli già filtrati per stato */
stati_obj_figli AS (
    SELECT 
        o.id_object_padre,
        mv.id_vers_padre,
        MAX(CASE WHEN o.ti_stato_object IN ('CHIUSO_ERR_SCHED', 'CHIUSO_ERR_VERIFICA_HASH') THEN 1 ELSE 0 END) as esiste_err_sched,
        MAX(CASE WHEN o.ti_stato_object IN ('CHIUSO_ERR_CODA','CHIUSO_ERR_VERS') THEN 1 ELSE 0 END) as esiste_err_vers,
        MAX(CASE WHEN o.ti_stato_object IN ('IN_ATTESA_SCHED', 'IN_CODA_HASH') THEN 1 ELSE 0 END) as esiste_in_corso
    FROM PIG_OBJECT o
    INNER JOIN MultiVersatori mv ON mv.id_vers_figlio = o.id_vers
    WHERE o.id_object_padre IS NOT NULL 
      AND o.ti_stato_object IN (
          'CHIUSO_ERR_SCHED', 'CHIUSO_ERR_VERIFICA_HASH',
          'CHIUSO_ERR_CODA', 'CHIUSO_ERR_VERS',
          'IN_ATTESA_SCHED', 'IN_CODA_HASH'
      )
    GROUP BY o.id_object_padre, mv.id_vers_padre
),
/* 3. Warning chiave duplicata solo figli */
warning_figli_dup AS (
    SELECT DISTINCT 
        o.id_object_padre,
        mv.id_vers_padre
    FROM PIG_UNITA_DOC_OBJECT ud
    INNER JOIN PIG_OBJECT o ON o.id_object = ud.id_object
    INNER JOIN MultiVersatori mv ON mv.id_vers_figlio = ud.id_vers
    WHERE ud.ti_stato_unita_doc_object = 'VERSATA_ERR' 
      AND ud.cd_err_sacer IN ('UD-002','UD-002-001')
      AND o.id_object_padre IS NOT NULL
),
/* 4. Warning chiave duplicata diretta */
warning_diretti_dup AS (
    SELECT DISTINCT 
        ud.id_object,
        mv.id_vers_padre
    FROM PIG_UNITA_DOC_OBJECT ud
        ...
        WHEN ti_obj.ti_vers_file = 'DA_TRASFORMARE' THEN
            CASE
                WHEN obj.ti_stato_object <> 'VERSATO_A_PING' THEN
                    CASE 
                        WHEN obj.ti_stato_object = 'CHIUSO_OK' AND w_figli.id_object_padre IS NOT NULL THEN 'WARNING_CHIAVE_DUPLICATA'
                        ELSE obj.ti_stato_object 
                    END
                ELSE 
                    -- Caso VERSATO_A_PING
                    CASE
                        WHEN COALESCE(sof.esiste_in_corso, 0) = 1 THEN 'VERSATO_A_PING'
                        WHEN COALESCE(sof.esiste_err_sched, 0) = 1 THEN 'PROBLEMA_PREPARAZIONE_SIP'
                        WHEN COALESCE(sof.esiste_err_vers, 0) = 1 THEN 'PROBLEMA_VERS_SACER'
                        ELSE 'IN_CORSO_VERS_SACER'
                    END
            END
        -- Caso NON DA TRASFORMARE
        ELSE 
            CASE
                WHEN obj.ti_stato_object = 'CHIUSO_OK' AND w_diretti.id_object IS NOT NULL THEN 'WARNING_CHIAVE_DUPLICATA'
                ELSE obj.ti_stato_object
            END
    END as ti_stato_object,
    CASE
...
LEFT JOIN stati_obj_figli sof ON sof.id_object_padre = obj.id_object AND sof.id_vers_padre = obj.id_vers
LEFT JOIN warning_figli_dup w_figli ON w_figli.id_object_padre = obj.id_object AND w_figli.id_vers_padre = obj.id_vers
LEFT JOIN warning_diretti_dup w_diretti ON w_diretti.id_object = obj.id_object AND w_diretti.id_vers_padre = obj.id_vers
WHERE 
    obj.ti_stato_object IN ('CHIUSO_OK', 'IN_CODA_HASH', 'IN_ATTESA_FILE', 'IN_ATTESA_SCHED', 'IN_ATTESA_VERS', 
                            'IN_CODA_VERS', 'WARNING', 'CHIUSO_WARNING', 'DA_TRASFORMARE', 
                            'TRASFORMAZIONE_NON_ATTIVA', 'TRASFORMAZIONE_IN_CORSO', 
                            'PREPARAZIONE_OGG_IN_CORSO', 'TRASFORMATO', 'VERSATO_A_PING', 
                            'ERRORE_TRASFORMAZIONE', 'WARNING_TRASFORMAZIONE', 'ERRORE_VERSAMENTO_A_PING')
    AND vers.fl_cessato = 0;

-- changeset root:1770027412470-69
...
-- changeset root:1770027412470-70
...
-- changeset root:1770027412470-71
COMMENT ON COLUMN MON_V_VIS_OBJ_TRASF.ID_OBJECT_TRASF IS 'PK.1';

-- changeset root:1770027412470-72
...
-- changeset root:1770027412470-93
...
-- changeset root:1770027412470-96
COMMENT ON COLUMN USR_V_CHK_USER_CANC_PING.ID_USER_IAM IS 'PK.1';

-- changeset root:1770027412470-97
...
-- changeset root:1770027412470-102
COMMENT ON COLUMN PIG_V_SU_LIST.NM_TIPO_STRUMENTO_URBANISTICO IS 'PK.1';

-- changeset root:1770027412470-103
CREATE OR REPLACE FORCE VIEW "MON_V_VIS_LAST_SCHED_JOB" ("ID_LOG_JOB", "NM_JOB", "DT_REG_LOG_JOB_INI", "FL_JOB_ATTIVO", "LAST_EXEC_OK") AS SELECT 
    -- recupero ID dell'ultimo avvio
    MAX(CASE WHEN ti_reg_log_job = 'INIZIO_SCHEDULAZIONE' THEN id_log_job END) AS id_log_job,
    nm_job,
    -- recupero la data dell'ultimo avvio
    MAX(CASE WHEN ti_reg_log_job = 'INIZIO_SCHEDULAZIONE' THEN dt_reg_log_job END) AS dt_reg_log_job_ini,
    -- verifico se l'avvio è più recente dell'ultima chiusura (FINE_SCHEDULAZIONE o ERRORE). Se non esiste ti_reg_log_job risulta comunque attivo per la condizione data INIZIO_SCHEDULAZIONE > 01/01/1900
    CASE 
        WHEN MAX(CASE WHEN ti_reg_log_job = 'INIZIO_SCHEDULAZIONE' THEN dt_reg_log_job END) > 
             COALESCE(MAX(CASE WHEN ti_reg_log_job IN ('FINE_SCHEDULAZIONE', 'ERRORE') THEN dt_reg_log_job END), TO_DATE('01/01/1900','DD/MM/YYYY'))
        THEN '1' 
        ELSE '0' 
    END AS fl_job_attivo,
    -- calcolo last_exec_ok indipendentemente dall'eventuale job in corso. Se non esiste ti_reg_log_job risulta comunque OK per la condizione data FINE_SCHEDULAZIONE >= 01/01/1900
    CASE 
        WHEN MAX(CASE WHEN ti_reg_log_job = 'FINE_SCHEDULAZIONE' THEN dt_reg_log_job END) >= 
             COALESCE(MAX(CASE WHEN ti_reg_log_job = 'ERRORE' THEN dt_reg_log_job END), TO_DATE('01/01/1900','DD/MM/YYYY'))
        THEN '1' 
        ELSE '0' 
    END AS last_exec_ok
FROM PIG_LOG_JOB
GROUP BY nm_job
HAVING MAX(CASE WHEN ti_reg_log_job = 'INIZIO_SCHEDULAZIONE' THEN dt_reg_log_job END) IS NOT NULL;

-- changeset root:1770027412470-104
COMMENT ON COLUMN MON_V_VIS_LAST_SCHED_JOB.ID_LOG_JOB IS 'PK.1 relativa a tabella PIG_LOG_JOB';

-- changeset root:1770027412470-105
...
-- changeset root:1770027412470-106
...
-- changeset root:1770027412470-109
...
-- changeset root:1770027412470-139
COMMENT ON COLUMN APL_V_PARAM_APPLIC.NM_PARAM_APPLIC IS 'PK.1';

-- changeset root:1770027412470-140
...
-- changeset root:1770027412470-151
...
-- changeset root:1770027412470-152
COMMENT ON COLUMN PIG_V_CHK_ORG_VERS_SACER.ID_OBJECT IS 'PK.1';

-- changeset root:1770027412470-153
...
-- changeset root:1770027412470-154
COMMENT ON COLUMN PIG_V_CHK_SIMULA_VERS_SACER.ID_OBJECT IS 'PK.1';

-- changeset root:1770027412470-155
...
-- changeset root:1770027412470-160
COMMENT ON COLUMN PIG_V_CHK_SES_PREC_NOT_ANNUL.ID_OBJECT IS 'PK.1';

-- changeset root:1770027412470-161
...
-- changeset root:1770027412470-162
COMMENT ON COLUMN MON_V_CHK_OBJ_TERMINATO.ID_OBJECT IS 'PK.1';

-- changeset root:1770027412470-163
...
-- changeset root:1770027412470-179
COMMENT ON COLUMN PIG_V_SISMA_CHECKS.ID_SISMA IS 'PK.1';

-- changeset root:1770027412470-180
...
-- changeset root:1770027412470-181
...
-- changeset root:1770027412470-191
COMMENT ON COLUMN APL_V_RANGE_MBYTE_CODA.NI_LIMITE_INF IS 'PK.1';

-- changeset root:1770027412470-192
...
-- changeset root:1770027412470-193
...
-- changeset root:1770027412470-194
...
-- changeset root:1770027412470-195
...
-- changeset root:1770027412470-196
...
-- changeset root:1770027412470-197
...
-- changeset root:1770027412470-200
...
-- changeset root:1770027412470-201
...
-- changeset root:1770027412470-202
...
-- changeset root:1770027412470-203
CREATE SEQUENCE SPIG_DEC_JOB START WITH 121 INCREMENT BY 1 MINVALUE 1 MAXVALUE 999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-204
...
-- changeset root:1770027412470-205
...
-- changeset root:1770027412470-206
...
-- changeset root:1770027412470-207
CREATE SEQUENCE SPIG_ERRORE START WITH 501 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-208
CREATE SEQUENCE SPIG_FASCICOLO_OBJECT START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-209
CREATE SEQUENCE SPIG_FASCICOLO_SESSIONE START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-210
...
-- changeset root:1770027412470-211
CREATE SEQUENCE SPIG_FILE_OBJECT_STORAGE START WITH 4470 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-212
...
-- changeset root:1770027412470-213
...
-- changeset root:1770027412470-214
...
-- changeset root:1770027412470-215
...
-- changeset root:1770027412470-216
CREATE SEQUENCE SPIG_PARAM_APPLIC START WITH 862 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-217
...
-- changeset root:1770027412470-218
...
-- changeset root:1770027412470-219
...
-- changeset root:1770027412470-220
...
-- changeset root:1770027412470-221
...
-- changeset root:1770027412470-222
...
-- changeset root:1770027412470-223
CREATE SEQUENCE SPIG_SISMA_DOCUMENTI_STORAGE START WITH 4470 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-224
...
-- changeset root:1770027412470-225
...
-- changeset root:1770027412470-226
...
-- changeset root:1770027412470-227
...
-- changeset root:1770027412470-228
...
-- changeset root:1770027412470-229
...
-- changeset root:1770027412470-230
...
-- changeset root:1770027412470-231
...
-- changeset root:1770027412470-232
...
-- changeset root:1770027412470-233
...
-- changeset root:1770027412470-234
...
-- changeset root:1770027412470-235
...
-- changeset root:1770027412470-236
...
-- changeset root:1770027412470-237
...
-- changeset root:1770027412470-238
...
-- changeset root:1770027412470-239
...
-- changeset root:1770027412470-240
CREATE SEQUENCE SPIG_STRUM_URB_DOCUMENTI_STORAGE START WITH 4470 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-241
...
-- changeset root:1770027412470-242
...
-- changeset root:1770027412470-243
...
-- changeset root:1770027412470-244
...
-- changeset root:1770027412470-245
...
-- changeset root:1770027412470-246
...
-- changeset root:1770027412470-247
...
-- changeset root:1770027412470-248
...
-- changeset root:1770027412470-249
...
-- changeset root:1770027412470-250
...
-- changeset root:1770027412470-251
...
-- changeset root:1770027412470-252
...
-- changeset root:1770027412470-253
...
-- changeset root:1770027412470-254
...
-- changeset root:1770027412470-255
...
-- changeset root:1770027412470-256
...
-- changeset root:1770027412470-257
CREATE SEQUENCE SPIG_XML_SACER_FASCICOLO START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-258
CREATE SEQUENCE SPIG_XML_SACER_FASCICOLO_SES START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-259
...
-- changeset root:1770027412470-260
...
-- changeset root:1770027412470-261
...
-- changeset root:1770027412470-262
...
-- changeset root:1770027412470-263
...
-- changeset root:1770027412470-264
CREATE SEQUENCE SXFO_REPORT_OBJECT_STORAGE START WITH 4470 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999999999999999999999 CACHE 20 NOORDER;

-- changeset root:1770027412470-265
...
-- changeset root:1770027412470-266
...
-- changeset root:1770027412470-267
...
-- changeset root:1770027412470-268
...
-- changeset root:1770027412470-269
...
-- changeset root:1770027412470-270
...
-- changeset root:1770027412470-271
...
-- changeset root:1770027412470-272
...
-- changeset root:1770027412470-273 splitStatements:true
...
-- changeset root:1770027412470-274 splitStatements:true
...
-- changeset root:1770027412470-275 splitStatements:true
...
-- changeset root:1770027412470-276 splitStatements:true
...
-- changeset root:1770027412470-277 splitStatements:true
...
-- changeset root:1770027412470-278
...
-- changeset root:1770027412470-279 splitStatements:true
...
-- changeset root:1770027412470-280 splitStatements:true
...
-- changeset root:1770027412470-281 splitStatements:true
...
-- changeset root:1770027412470-282 splitStatements:true
...
-- changeset root:1770027412470-283 splitStatements:true
...
-- changeset root:1770027412470-284 splitStatements:true
...
-- changeset root:1770027412470-285 splitStatements:true
...
-- changeset root:1770027412470-286 splitStatements:true
...
-- changeset root:1770027412470-287 splitStatements:true
...
-- changeset root:1770027412470-288 splitStatements:true
...
-- changeset root:1770027412470-289 splitStatements:true
...
-- changeset root:1770027412470-290 splitStatements:true
...
-- changeset root:1770027412470-291
...
-- changeset root:1770027412470-292
...
-- changeset root:1770027412470-293 splitStatements:true
...
-- changeset root:1770027412470-294 splitStatements:true
...
-- changeset root:1770027412470-295 splitStatements:true
...
-- changeset root:1770027412470-296 splitStatements:true
...
-- changeset root:1770027412470-297
...
-- changeset root:1770027412470-298
...
-- changeset root:1770027412470-299
...
-- changeset root:1770027412470-300
...
-- changeset root:1770027412470-301
...
-- changeset root:1770027412470-302
...
-- changeset root:1770027412470-303
...
-- changeset root:1770027412470-304
...
-- changeset root:1770027412470-305
...
-- changeset root:1770027412470-306
...
-- changeset root:1770027412470-307
...
-- changeset root:1770027412470-308
...
-- changeset root:1770027412470-309
...
-- changeset root:1770027412470-310
...
-- changeset root:1770027412470-311
...
-- changeset root:1770027412470-312
...
-- changeset root:1770027412470-313
...
-- changeset root:1770027412470-314
...
-- changeset root:1770027412470-315
...
-- changeset root:1770027412470-316
...
-- changeset root:1770027412470-317
...
-- changeset root:1770027412470-318
...
-- changeset root:1770027412470-319
...
-- changeset root:1770027412470-320
...
-- changeset root:1770027412470-321
...
-- changeset root:1770027412470-322
...
-- changeset root:1770027412470-323
...
-- changeset root:1770027412470-324
...
-- changeset root:1770027412470-325
...
-- changeset root:1770027412470-326
...
-- changeset root:1770027412470-331
...
-- changeset root:1770027412470-332
...
-- changeset root:1770027412470-333
...
-- changeset root:1770027412470-336
...
-- changeset root:1770027412470-355
...
-- changeset root:1770027412470-356
...
-- changeset root:1770027412470-424
...
-- changeset root:1770027412470-425
...
-- changeset root:1770027412470-426
...
-- changeset root:1770027412470-506
...
-- changeset root:1770027412470-507
...
-- changeset root:1770027412470-508
...
-- changeset root:1770027412470-509
...
-- changeset root:1770027412470-510
...
-- changeset root:1770027412470-511
...
-- changeset root:1770027412470-512
...
-- changeset root:1770027412470-513
...
-- changeset root:1770027412470-514
...
-- changeset root:1770027412470-515
...
-- changeset root:1770027412470-516
...
-- changeset root:1770027412470-517
...
-- changeset root:1770027412470-518
...
-- changeset root:1770027412470-521
...
-- changeset root:1770027412470-522
...
-- changeset root:1770027412470-523
...
-- changeset root:1770027412470-524
...
-- changeset root:1770027412470-525
...
-- changeset root:1770027412470-526
...
-- changeset root:1770027412470-527
...
-- changeset root:1770027412470-528
...
-- changeset root:1770027412470-529
...
-- changeset root:1770027412470-530
...
-- changeset root:1770027412470-531
...
-- changeset root:1770027412470-532
...
-- changeset root:1770027412470-533
...
-- changeset root:1770027412470-534
...
-- changeset root:1770027412470-535
...
-- changeset root:1770027412470-536
...
-- changeset root:1770027412470-537
...
-- changeset root:1770027412470-538
...
-- changeset root:1770027412470-539
...
-- changeset root:1770027412470-540
...
-- changeset root:1770027412470-541
...
-- changeset root:1770027412470-542
...
-- changeset root:1770027412470-543
...
-- changeset root:1770027412470-544
...
-- changeset root:1770027412470-545
...
-- changeset root:1770027412470-546
...
-- changeset root:1770027412470-547
...
-- changeset root:1770027412470-548
...
-- changeset root:1770027412470-549
...
-- changeset root:1770027412470-550
...
-- changeset root:1770027412470-555
...
-- changeset root:1770027412470-556
...
-- changeset root:1770027412470-557
...
-- changeset root:1770027412470-558
...
-- changeset root:1770027412470-559
...
-- changeset root:1770027412470-560
...
-- changeset root:1770027412470-561
...
-- changeset root:1770027412470-562
...
-- changeset root:1770027412470-563
...
-- changeset root:1770027412470-564
...
-- changeset root:1770027412470-565
...
-- changeset root:1770027412470-566
...
-- changeset root:1770027412470-567
...
-- changeset root:1770027412470-568
...
-- changeset root:1770027412470-569
...
-- changeset root:1770027412470-570
...
-- changeset root:1770027412470-571
...
-- changeset root:1770027412470-572
...
-- changeset root:1770027412470-576
...
-- changeset root:1770027412470-577
...
-- changeset root:1770027412470-578
...
-- changeset root:1770027412470-579
...
-- changeset root:1770027412470-580
...
-- changeset root:1770027412470-581
...
-- changeset root:1770027412470-582
...
-- changeset root:1770027412470-583
...
-- changeset root:1770027412470-584
...
-- changeset root:1770027412470-585
...
-- changeset root:1770027412470-586
...
-- changeset root:1770027412470-587
...
-- changeset root:1770027412470-588
...
-- changeset root:1770027412470-589
...
-- changeset root:1770027412470-590
...
-- changeset root:1770027412470-591
...
-- changeset root:1770027412470-592
...
-- changeset root:1770027412470-593
...
-- changeset root:1770027412470-594
...
-- changeset root:1770027412470-595
...
-- changeset root:1770027412470-596
...
-- changeset root:1770027412470-597
...
-- changeset root:1770027412470-598
...
-- changeset root:1770027412470-599
...
-- changeset root:1770027412470-600
...
-- changeset root:1770027412470-601
...
-- changeset root:1770027412470-602
...
-- changeset root:1770027412470-603
...
-- changeset root:1770027412470-604
...
-- changeset root:1770027412470-605
...
-- changeset root:1770027412470-606

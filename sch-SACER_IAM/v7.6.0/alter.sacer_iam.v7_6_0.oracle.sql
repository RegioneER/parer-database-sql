...
-- changeset root:1770027191760-103
ALTER TABLE DEC_TIPO_DOC_PROCESSO_CONSERV DROP CONSTRAINT FK_TIPO_DOC_PROCESSO_CONSERV_STRUT;

-- changeset root:1770027191760-62
...
-- changeset root:1770027191760-67
...
-- changeset root:1770027191760-68
...
-- changeset root:1770027191760-69
...
-- changeset root:1770027191760-70
...
-- changeset root:1770027191760-71
...
-- changeset root:1770027191760-72
...
-- changeset root:1770027191760-73
...
-- changeset root:1770027191760-77
...
-- changeset root:1770027191760-81
...
-- changeset root:1770027191760-82
CREATE TABLE TMP_ORG_DI_VIGILANZA (ID_ENTE_SIAM NUMBER);

-- changeset root:1770027191760-83
...
-- changeset root:1770027191760-87
...
-- changeset root:1770027191760-88
...
-- changeset root:1770027191760-92
...
-- changeset root:1770027191760-93
...
-- changeset root:1770027191760-94
...
-- changeset root:1770027191760-97
...
-- changeset root:1770027191760-98
...
-- changeset root:1770027191760-99
...
-- changeset root:1770027191760-100
...
-- changeset root:1770027191760-101
CREATE TABLE USR_ORGANIZ_IAM_BCK_DELETE (ID_ORGANIZ_IAM NUMBER NOT NULL, ID_APPLIC NUMBER NOT NULL, ID_ORGANIZ_APPLIC NUMBER NOT NULL, ID_TIPO_ORGANIZ NUMBER NOT NULL, NM_ORGANIZ VARCHAR2(100 BYTE) NOT NULL, DS_ORGANIZ VARCHAR2(254 BYTE) NOT NULL, ID_ORGANIZ_IAM_PADRE NUMBER, ID_ENTE_CONSERV NUMBER, ID_ENTE_GESTORE NUMBER);

-- changeset root:1770027191760-102
ALTER TABLE DEC_DOC_PROCESSO_CONSERV ADD CONSTRAINT FK_TIPO_DOC_PROCESSO_CONSERV_STRUT FOREIGN KEY (ID_TIPO_DOC_PROCESSO_CONSERV) REFERENCES DEC_TIPO_DOC_PROCESSO_CONSERV (ID_TIPO_DOC_PROCESSO_CONSERV);

-- changeset root:1770027191760-1
DROP INDEX IDX_ABIL_ENTE_ACC_VIG;

-- changeset root:1770027191760-2
CREATE INDEX IDX_ABIL_ENTE_ACC_VIG ON USR_ABIL_ENTE_SIAM(ID_ACCORDO_VIGIL);

-- changeset root:1770027191760-3
DROP INDEX IDX_ABIL_ENTE_APP_COLLEG;

-- changeset root:1770027191760-4
CREATE INDEX IDX_ABIL_ENTE_APP_COLLEG ON USR_ABIL_ENTE_SIAM(ID_APPART_COLLEG_ENTI);

-- changeset root:1770027191760-5
DROP INDEX IDX_ABIL_ENTE_SUPT_EST;

-- changeset root:1770027191760-6
CREATE INDEX IDX_ABIL_ENTE_SUPT_EST ON USR_ABIL_ENTE_SIAM(ID_SUPT_EST_ENTE_CONVENZ);

-- changeset root:1770027191760-7
DROP INDEX IDX_STO_ENTE_AMB;

-- changeset root:1770027191760-8
CREATE INDEX IDX_STO_ENTE_AMB ON ORG_STO_ENTE_AMBIENTE_CONVENZ(ID_AMBIENTE_ENTE_CONVENZ);

-- changeset root:1770027191760-9
ALTER TABLE APL_NOTA_RILASCIO DROP PRIMARY KEY DROP INDEX;

-- changeset root:1770027191760-10
CREATE UNIQUE INDEX PK_APL_NOTA_RILASCIO ON APL_NOTA_RILASCIO(ID_NOTA_RILASCIO);

-- changeset root:1770027191760-11
...
-- changeset root:1770027191760-35
...
-- changeset root:1770027191760-60
...
-- changeset root:1770027191760-61
